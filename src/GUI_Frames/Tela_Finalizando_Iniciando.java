...
public class Tela_Finalizando_Iniciando extends javax.swing.JDialog {

    Conecta_Banco ObjConecta = new Conecta_Banco();
    
    public static Tela_Principal ObjTP;
    
    public Tela_Finalizando_Iniciando(Tela_Principal parent, boolean modal) {
        this.ObjTP = parent;
        this.setModal(modal);
        initComponents();
    ...
    new Thread(){
            ...
            public void run (){
                ...
                try {
                    ...
                    sleep(2000);
                    ObjTP.Fechar_Tela_Principal();              
                    
                    JTF_Mensagem.setText("O Sistema Está Sendo Encerrado...");
                    sleep(2000);
                    
                    JTF_Mensagem.setText("O Sistema Está Sendo Reiniciado...");
                    sleep(3000);

                    dispose();
                    ObjTP.TP=null;
                    ObjTP.getInstancia().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Finalizando_Iniciando.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Tela_Finalizando_Iniciando dialog = new Tela_Finalizando_Iniciando(ObjTP, true);
