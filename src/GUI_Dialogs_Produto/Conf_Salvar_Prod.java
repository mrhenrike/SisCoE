...
public class Conf_Salvar_Prod extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Prod ObjProd;
    
    
    public Conf_Salvar_Prod(Tela_Cadastro_Prod parent, boolean modal) {
        this.ObjProd = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void JB_NaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_NaoActionPerformed
        dispose();
        ObjProd.Mostrar_Dados_Nao_Salvos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Prod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Prod dialog = new Conf_Salvar_Prod(ObjProd, true);
