...
public class Inf_Produto_Existente_Lote_Saida extends javax.swing.JDialog {
    
    public static Tela_Saida_Produto ObjSaida;
    
    public Inf_Produto_Existente_Lote_Saida(Tela_Saida_Produto parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("O produto e o lote já existe na lista!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Produto_Existente_Lote_Saida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Produto_Existente_Lote_Saida dialog = new Inf_Produto_Existente_Lote_Saida(ObjSaida, true);
