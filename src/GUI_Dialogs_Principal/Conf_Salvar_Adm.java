...
import GUI_Frames.Tela_Cadastro_Inicial;


public class Conf_Salvar_Adm extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Inicial ObjCad;
    
    
    public Conf_Salvar_Adm(Tela_Cadastro_Inicial parent, boolean modal) {
        this.ObjCad = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Confirma o cadastro do administrador?");
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
       dispose();
       ObjCad.Conf_Inserir_Adm();
       ObjCad.OPen_Tela_Inicial();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Adm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Adm dialog = new Conf_Salvar_Adm(ObjCad, true);
