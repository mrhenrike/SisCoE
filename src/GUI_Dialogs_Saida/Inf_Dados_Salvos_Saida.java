...
public class Inf_Dados_Salvos_Saida extends javax.swing.JDialog {
    
    public static Tela_Saida_Produto ObjSaida;
    
    public Inf_Dados_Salvos_Saida(Tela_Saida_Produto parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Saída efetivada com sucesso!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Salvos_Saida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Salvos_Saida dialog = new Inf_Dados_Salvos_Saida(ObjSaida, true);
