...
public class Conf_Salvar_Turma extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Curso_Turma ObjCurso;
    
    
    public Conf_Salvar_Turma(Tela_Cadastro_Curso_Turma parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Turma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Turma dialog = new Conf_Salvar_Turma(ObjCurso, true);
