...
public class Tela_Consulta_Entrada_Cancela_DL extends javax.swing.JDialog {

    Conecta_Banco ObjConecta = new Conecta_Banco();
    Tela_Cancelar_Entrada_Produto ObjCancelaEntrada = new Tela_Cancelar_Entrada_Produto();
    ...
    public Tela_Consulta_Entrada_Cancela_DL(Tela_Cancelar_Entrada_Produto parent, boolean modal) {
        this.ObjCancelaEntrada = parent;
        this.setModal(modal);
    ...
    private void JTB_EntradasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTB_EntradasMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            ObjCancelaEntrada.Testar_Campos_Pesquisa_Entrada(String.valueOf(id));
            dispose();
        }
 ...
 public final void Setar_Atalho_BT(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Consulta_Entrada_Cancela_DL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Tela_Consulta_Entrada_Cancela_DL dialog = new Tela_Consulta_Entrada_Cancela_DL(new Tela_Cancelar_Entrada_Produto(), true);
