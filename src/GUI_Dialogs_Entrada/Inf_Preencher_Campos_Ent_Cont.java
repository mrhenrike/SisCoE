...
public class Inf_Preencher_Campos_Ent_Cont extends javax.swing.JDialog {
    
    public static Tela_Entrada_Produto_Cont ObjEntradaProd;
    
    public Inf_Preencher_Campos_Ent_Cont(Tela_Entrada_Produto_Cont parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Ent_Cont.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Campos_Ent_Cont dialog = new Inf_Preencher_Campos_Ent_Cont(ObjEntradaProd, true);
