...
import GUI_Frames.Tela_Relat_Log;


public class Inf_Preencher_Datas_Relat_Log extends javax.swing.JDialog {
    
    public static Tela_Relat_Log ObjRelatEntProd;
    
    public Inf_Preencher_Datas_Relat_Log(Tela_Relat_Log parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Datas_Relat_Log.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Datas_Relat_Log dialog = new Inf_Preencher_Datas_Relat_Log(ObjRelatEntProd, true);
