...
public class Inf_Saida_Ja_Cancel extends javax.swing.JDialog {
    
    public static Tela_Cancelar_Saida ObjSaida;
    
    public Inf_Saida_Ja_Cancel(Tela_Cancelar_Saida parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Essa saída já foi cancelada!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Saida_Ja_Cancel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Saida_Ja_Cancel dialog = new Inf_Saida_Ja_Cancel(ObjSaida, true);
