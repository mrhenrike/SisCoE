...
public class Inf_Cadastro_Existente_Prod extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Prod Obj;
    
    public Inf_Cadastro_Existente_Prod(Tela_Cadastro_Prod parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Cadastro_Existente_Prod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Cadastro_Existente_Prod dialog = new Inf_Cadastro_Existente_Prod(Obj, true);
