...
public class Inf_Selecione_Linha_Saida_Dev extends javax.swing.JDialog {
    
    public static Tela_Consulta_Saida_Devolucao_DL ObjSaida;
    
    public Inf_Selecione_Linha_Saida_Dev(Tela_Consulta_Saida_Devolucao_DL parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Selecione_Linha_Saida_Dev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Selecione_Linha_Saida_Dev dialog = new Inf_Selecione_Linha_Saida_Dev(ObjSaida, true);
