...
public class Conf_Salvar_Ativ_Disciplina extends javax.swing.JDialog {
    
    public static Tela_Ativacao ObjAtiv;
    
    
    public Conf_Salvar_Ativ_Disciplina(Tela_Ativacao parent, boolean modal) {
        this.ObjAtiv = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
       dispose();
       ObjAtiv.Conf_Ativar_Disciplina();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Ativ_Disciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Ativ_Disciplina dialog = new Conf_Salvar_Ativ_Disciplina(ObjAtiv, true);
