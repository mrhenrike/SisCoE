...
public class Inf_Preencher_Campos_Relat_Saida_Prod extends javax.swing.JDialog {
    
    public static Tela_Relat_Produto_Saida_Periodo ObjRelatEnt;
    
    public Inf_Preencher_Campos_Relat_Saida_Prod(Tela_Relat_Produto_Saida_Periodo parent, boolean modal) {
        this.ObjRelatEnt = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
        setSize(370,130);
        setLocationRelativeTo(ObjRelatEnt);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Relat_Saida_Prod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_Campos_Relat_Saida_Prod dialog = new Inf_Preencher_Campos_Relat_Saida_Prod(ObjRelatEnt, true);
