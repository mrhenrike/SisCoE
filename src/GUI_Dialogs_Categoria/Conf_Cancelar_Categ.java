...
public class Conf_Cancelar_Categ extends javax.swing.JDialog {
    ...
    public Conf_Cancelar_Categ(Tela_Cadastro_Categoria_DL parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Cancelar_Categ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Cancelar_Categ dialog = new Conf_Cancelar_Categ(ObjCategoria, true);
