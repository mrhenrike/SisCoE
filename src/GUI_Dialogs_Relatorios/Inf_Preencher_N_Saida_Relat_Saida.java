...
import GUI_Frames.Tela_Relat_Saida_Num;



public class Inf_Preencher_N_Saida_Relat_Saida extends javax.swing.JDialog {
    
    public static Tela_Relat_Saida_Num ObjRelatEnt;
    
    public Inf_Preencher_N_Saida_Relat_Saida(Tela_Relat_Saida_Num parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_N_Saida_Relat_Saida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_N_Saida_Relat_Saida dialog = new Inf_Preencher_N_Saida_Relat_Saida(ObjRelatEnt, true);
