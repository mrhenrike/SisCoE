...
public class Conf_Excluir_Ent_Cont_Iten extends javax.swing.JDialog {
    
    public static Tela_Entrada_Produto_Cont ObjEntrada;
    
    
    public Conf_Excluir_Ent_Cont_Iten(Tela_Entrada_Produto_Cont parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tem certeza que deseja excluir a linha?");
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
       dispose();
       ObjEntrada.Conf_Excluir_Iten_Entrada();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Excluir_Ent_Cont_Iten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        /* Create and display the dialog */
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Conf_Excluir_Ent_Cont_Iten dialog = new Conf_Excluir_Ent_Cont_Iten(ObjEntrada, true);
