...
public class Inf_Preencher_Lote_Validade_Ent extends javax.swing.JDialog {
    
    public static Tela_Entrada_Produto ObjEntradaProd;
    
    public Inf_Preencher_Lote_Validade_Ent(Tela_Entrada_Produto parent, boolean modal) {
