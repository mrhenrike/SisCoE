...
import GUI_Dialogs_Relatorios.Inf_Preencher_Campos_Relat_Estoque_Prod_Categoria;
...
public class Tela_Relat_Estoque_Produto_Categoria extends javax.swing.JInternalFrame {
    
    public static Tela_Relat_Estoque_Produto_Categoria Obj;
    
    public void Open_Tela(){
        if(Obj==null){
            Obj = new Tela_Relat_Estoque_Produto_Categoria();
    ...
    private static Inf_Preencher_Campos_Relat_Estoque_Prod_Categoria ObjPreencherCampos;

    public Tela_Relat_Estoque_Produto_Categoria() {
        initComponents();
    ...
    public void Testar_Campos(){
        if(JCB_Categoria.getSelectedIndex()<=0){
            ...
            ObjRelatProd.Relatorio_Produto_Estoque_Categoria_Selecionada(ObjControlCategoria.Id_Cat);
            new Controle_Log().Registrar_Log("Gerou o relatório de estoque de produto por categoria selecionada id: "+ObjControlCategoria.Id_Cat+" - "
                    +JCB_Categoria.getSelectedItem().toString().trim(), CodLogado);
        }              
    } 
    
    public void Mostrar_Preencher_Campos(){
        ObjPreencherCampos = new Inf_Preencher_Campos_Relat_Estoque_Prod_Categoria(this, true);
