...
import GUI_Frames.Tela_Relat_Usuario;



public class Inf_Preencher_Campos_Relat_Usuario extends javax.swing.JDialog {
    
    public static Tela_Relat_Usuario Obj;
    
    public Inf_Preencher_Campos_Relat_Usuario(Tela_Relat_Usuario parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Relat_Usuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Campos_Relat_Usuario dialog = new Inf_Preencher_Campos_Relat_Usuario(Obj, true);
