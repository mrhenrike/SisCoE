...
public class Inf_Data_Final_Inferior_Cons_Log extends javax.swing.JDialog {
    
    public static Tela_Consulta_Log Obj;
    
    public Inf_Data_Final_Inferior_Cons_Log(Tela_Consulta_Log parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Data_Final_Inferior_Cons_Log.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Data_Final_Inferior_Cons_Log dialog = new Inf_Data_Final_Inferior_Cons_Log(Obj, true);
