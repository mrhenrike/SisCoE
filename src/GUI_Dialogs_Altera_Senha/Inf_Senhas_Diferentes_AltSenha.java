...
public class Inf_Senhas_Diferentes_AltSenha extends javax.swing.JDialog {
    
    public static Tela_Alterar_Senha ObjAlteraSenha;
    
    public Inf_Senhas_Diferentes_AltSenha(Tela_Alterar_Senha parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Senhas_Diferentes_AltSenha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Senhas_Diferentes_AltSenha dialog = new Inf_Senhas_Diferentes_AltSenha(ObjAlteraSenha, true);
    ...
    private javax.swing.JButton JB_Ok3;
    private javax.swing.JButton JB_Ok4;
