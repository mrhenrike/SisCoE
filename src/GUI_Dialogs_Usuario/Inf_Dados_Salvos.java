...
public class Inf_Dados_Salvos extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Usuario ObjUser;
    
    public Inf_Dados_Salvos(Tela_Cadastro_Usuario parent, boolean modal) {
        this.ObjUser = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Salvos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Salvos dialog = new Inf_Dados_Salvos(ObjUser, true);
