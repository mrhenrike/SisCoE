...
public class Inf_Produto_Existente_Ent extends javax.swing.JDialog {
    
    public static Tela_Entrada_Produto ObjEntrada;
    
    public Inf_Produto_Existente_Ent(Tela_Entrada_Produto parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Produto_Existente_Ent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Produto_Existente_Ent dialog = new Inf_Produto_Existente_Ent(ObjEntrada, true);
