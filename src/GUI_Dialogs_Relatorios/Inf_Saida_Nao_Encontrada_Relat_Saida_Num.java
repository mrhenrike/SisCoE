...
public class Inf_Saida_Nao_Encontrada_Relat_Saida_Num extends javax.swing.JDialog {
    
    public static Tela_Relat_Saida_Num Obj;
    
    public Inf_Saida_Nao_Encontrada_Relat_Saida_Num(Tela_Relat_Saida_Num parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Saida_Nao_Encontrada_Relat_Saida_Num.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Saida_Nao_Encontrada_Relat_Saida_Num dialog = new Inf_Saida_Nao_Encontrada_Relat_Saida_Num(Obj, true);
