...
public class Conf_Alterar_Categoria1 extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Categoria_DL1 ObjCategoria;
    
    
    public Conf_Alterar_Categoria1(Tela_Cadastro_Categoria_DL1 parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Alterar_Categoria1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Alterar_Categoria1 dialog = new Conf_Alterar_Categoria1(ObjCategoria, true);
