...
public class Logoff extends javax.swing.JDialog {
    
    public static Tela_Principal ObjTP;
    
    public Logoff(Tela_Principal parent, boolean modal) {
        this.ObjTP = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
        ...
        obj.Registrar_Log("encerrou o sistema", ObjTP.CodLogado);
        dispose();
        ObjTP.setVisible(false);
        ObjTP.Mostrar_Finalizando();
        ObjTP.setVisible(true);
        ObjTP.Encerrar_Tela_Principal();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Logoff dialog = new Logoff(ObjTP, true);
