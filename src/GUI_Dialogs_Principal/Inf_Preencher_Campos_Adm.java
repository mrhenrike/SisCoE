...
public class Inf_Preencher_Campos_Adm extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Inicial ObjCad;
    
    public Inf_Preencher_Campos_Adm(Tela_Cadastro_Inicial parent, boolean modal) {
        this.ObjCad = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Adm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_Campos_Adm dialog = new Inf_Preencher_Campos_Adm(ObjCad, true);
