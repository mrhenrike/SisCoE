...
public class Inf_Preencher_Campos_Ent_Canc extends javax.swing.JDialog {
    
    public static Tela_Cancelar_Entrada_Produto ObjEntradaProd;
    
    public Inf_Preencher_Campos_Ent_Canc(Tela_Cancelar_Entrada_Produto parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Ent_Canc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Campos_Ent_Canc dialog = new Inf_Preencher_Campos_Ent_Canc(ObjEntradaProd, true);
