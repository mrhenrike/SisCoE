...
public class Inf_Dev_Ja_Efetivada_Dev extends javax.swing.JDialog {
    
    public static Tela_Gerar_Devolucao ObjDev;
    
    public Inf_Dev_Ja_Efetivada_Dev(Tela_Gerar_Devolucao parent, boolean modal) {
        this.ObjDev = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Essa devolução já foi efetivada!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dev_Ja_Efetivada_Dev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Dev_Ja_Efetivada_Dev dialog = new Inf_Dev_Ja_Efetivada_Dev(ObjDev, true);
