...
import GUI_Frames.Tela_Relat_Estoque_Produto_Categoria;



public class Inf_Preencher_Campos_Relat_Estoque_Prod_Categoria extends javax.swing.JDialog {
    
    public static Tela_Relat_Estoque_Produto_Categoria ObjRelatProdCat;
    
    public Inf_Preencher_Campos_Relat_Estoque_Prod_Categoria(Tela_Relat_Estoque_Produto_Categoria parent, boolean modal) {
        this.ObjRelatProdCat = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
        setSize(370,130);
        setLocationRelativeTo(ObjRelatProdCat);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Relat_Estoque_Prod_Categoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Campos_Relat_Estoque_Prod_Categoria dialog = new Inf_Preencher_Campos_Relat_Estoque_Prod_Categoria(ObjRelatProdCat, true);
