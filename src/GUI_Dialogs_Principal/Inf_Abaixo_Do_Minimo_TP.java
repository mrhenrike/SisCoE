...
public class Inf_Abaixo_Do_Minimo_TP extends javax.swing.JDialog {
    
    public static Tela_Principal ObjTP;
    
    
    public Inf_Abaixo_Do_Minimo_TP(Tela_Principal parent, boolean modal) {
        this.ObjTP = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("abaixo do mínimo!");

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("Existe produto com estoque");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Abaixo_Do_Minimo_TP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }      
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Abaixo_Do_Minimo_TP dialog = new Inf_Abaixo_Do_Minimo_TP(ObjTP, true);
