...
public class Inf_Preencher_Campos_Prod extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Prod ObjProd;
    
    public Inf_Preencher_Campos_Prod(Tela_Cadastro_Prod parent, boolean modal) {
        this.ObjProd = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Prod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_Campos_Prod dialog = new Inf_Preencher_Campos_Prod(ObjProd, true);
