...
public class Inf_Preencher_Campos extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Usuario ObjUser;
    
    public Inf_Preencher_Campos(Tela_Cadastro_Usuario parent, boolean modal) {
        this.ObjUser = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_Campos dialog = new Inf_Preencher_Campos(ObjUser, true);
