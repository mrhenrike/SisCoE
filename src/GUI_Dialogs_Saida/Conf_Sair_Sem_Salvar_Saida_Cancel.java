...
public class Conf_Sair_Sem_Salvar_Saida_Cancel extends javax.swing.JDialog {
    
   public static Tela_Cancelar_Saida ObjSaida;
    
    public Conf_Sair_Sem_Salvar_Saida_Cancel(Tela_Cancelar_Saida parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Sair_Sem_Salvar_Saida_Cancel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Conf_Sair_Sem_Salvar_Saida_Cancel dialog = new Conf_Sair_Sem_Salvar_Saida_Cancel(ObjSaida, true);
