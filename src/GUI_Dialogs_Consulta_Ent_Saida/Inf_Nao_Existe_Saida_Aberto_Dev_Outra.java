...
public class Inf_Nao_Existe_Saida_Aberto_Dev_Outra extends javax.swing.JDialog {
    
    public static Tela_Consulta_Saida_Devolucao_Outra_DL ObjConsSaida;
    
    public Inf_Nao_Existe_Saida_Aberto_Dev_Outra(Tela_Consulta_Saida_Devolucao_Outra_DL parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Nao_Existe_Saida_Aberto_Dev_Outra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Nao_Existe_Saida_Aberto_Dev_Outra dialog = new Inf_Nao_Existe_Saida_Aberto_Dev_Outra(ObjConsSaida, true);
