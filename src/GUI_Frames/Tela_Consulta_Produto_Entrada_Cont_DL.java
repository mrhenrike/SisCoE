...
public class Tela_Consulta_Produto_Entrada_Cont_DL extends javax.swing.JDialog {
    ...
    Tela_Entrada_Produto_Cont ObjEntrada = new Tela_Entrada_Produto_Cont();
    ...
    public Tela_Consulta_Produto_Entrada_Cont_DL(Tela_Entrada_Produto_Cont parent, boolean modal) {
        ...
        Setar_Pesquisa(ObjEntrada.Pesquisa);   
        ...
        ObjControlProd.Contar_Produtos_Filtrados(JL_Itens_Filtrados,JL_Descricao.getText());
    ...
    public void Carregar_Dados_Produtos(Object LinhaSelecionada) throws SQLException {               
       ObjModeloProd.setPesquisa(String.valueOf(LinhaSelecionada));//seta no modelo produto o id de pesquisa    
 ...
 public final void Setar_Atalho_BT(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Consulta_Produto_Entrada_Cont_DL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Tela_Consulta_Produto_Entrada_Cont_DL dialog = new Tela_Consulta_Produto_Entrada_Cont_DL(new Tela_Entrada_Produto_Cont(), true);
