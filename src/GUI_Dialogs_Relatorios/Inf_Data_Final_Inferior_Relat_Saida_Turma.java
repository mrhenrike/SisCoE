...
public class Inf_Data_Final_Inferior_Relat_Saida_Turma extends javax.swing.JDialog {
    
    public static Tela_Relat_Saida_Turma ObjRelatEntProd;
    
    public Inf_Data_Final_Inferior_Relat_Saida_Turma(Tela_Relat_Saida_Turma parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Data_Final_Inferior_Relat_Saida_Turma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Data_Final_Inferior_Relat_Saida_Turma dialog = new Inf_Data_Final_Inferior_Relat_Saida_Turma(ObjRelatEntProd, true);
