...
public class Inf_Log_Nao_Encontrado extends javax.swing.JDialog {
    
    public static Tela_Consulta_Log Obj;
    
    public Inf_Log_Nao_Encontrado(Tela_Consulta_Log parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Log_Nao_Encontrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Log_Nao_Encontrado dialog = new Inf_Log_Nao_Encontrado(Obj, true);
