...
public class Inf_Cadastro_Existente_Categ extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Categoria_DL ObjCategoria;
    
    public Inf_Cadastro_Existente_Categ(Tela_Cadastro_Categoria_DL parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Cadastro_Existente_Categ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Cadastro_Existente_Categ dialog = new Inf_Cadastro_Existente_Categ(ObjCategoria, true);
