...
public class Conf_Salvar_Saida_Outra extends javax.swing.JDialog {
    
    public static Tela_Saida_Produto ObjSaida;
    
    
    public Conf_Salvar_Saida_Outra(Tela_Saida_Produto parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deseja efetivar essa saída?");
    ...
    private void JB_NaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_NaoActionPerformed
        dispose();
        ObjSaida.Mostrar_Dados_Nao_Salvos();        
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
       dispose();
       ObjSaida.Conf_Inserir_Saida_Outra();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Saida_Outra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Saida_Outra dialog = new Conf_Salvar_Saida_Outra(ObjSaida, true);
