...
public class Inf_Nao_Ha_Itens_Salvar_Saida extends javax.swing.JDialog {
    
    public static Tela_Saida_Produto ObjSaida;
    
    public Inf_Nao_Ha_Itens_Salvar_Saida(Tela_Saida_Produto parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Nao_Ha_Itens_Salvar_Saida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Nao_Ha_Itens_Salvar_Saida dialog = new Inf_Nao_Ha_Itens_Salvar_Saida(ObjSaida, true);
