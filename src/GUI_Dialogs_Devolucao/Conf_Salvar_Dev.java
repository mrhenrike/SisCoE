...
public class Conf_Salvar_Dev extends javax.swing.JDialog {
    
    public static Tela_Gerar_Devolucao ObjDev;
    
    
    public Conf_Salvar_Dev(Tela_Gerar_Devolucao parent, boolean modal) {
        this.ObjDev = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deseja efetivar essa devolução?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Dev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Dev dialog = new Conf_Salvar_Dev(ObjDev, true);
