...
public class Inf_Dados_Nao_Salvos_Ent_Canc extends javax.swing.JDialog {
    
    public static Tela_Cancelar_Entrada_Produto ObjEntrada;
    
    public Inf_Dados_Nao_Salvos_Ent_Canc(Tela_Cancelar_Entrada_Produto parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("A entrada não foi cancelada!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Nao_Salvos_Ent_Canc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Dados_Nao_Salvos_Ent_Canc dialog = new Inf_Dados_Nao_Salvos_Ent_Canc(ObjEntrada, true);
