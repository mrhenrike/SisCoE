...
public class Inf_Dados_Salvos_Categ1 extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Categoria_DL1 ObjCateg;
    
    public Inf_Dados_Salvos_Categ1(Tela_Cadastro_Categoria_DL1 parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Salvos_Categ1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Salvos_Categ1 dialog = new Inf_Dados_Salvos_Categ1(ObjCateg, true);
