...
public class Inf_Entrada_Nao_Encontrada_Relat_Ent_Num extends javax.swing.JDialog {
    
    public static Tela_Relat_Entrada_Num Obj;
    
    public Inf_Entrada_Nao_Encontrada_Relat_Ent_Num(Tela_Relat_Entrada_Num parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Entrada_Nao_Encontrada_Relat_Ent_Num.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Entrada_Nao_Encontrada_Relat_Ent_Num dialog = new Inf_Entrada_Nao_Encontrada_Relat_Ent_Num(Obj, true);
