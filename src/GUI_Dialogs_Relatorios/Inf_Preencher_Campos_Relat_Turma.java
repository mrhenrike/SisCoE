...
import GUI_Frames.Tela_Relat_Turma;



public class Inf_Preencher_Campos_Relat_Turma extends javax.swing.JDialog {
    
    public static Tela_Relat_Turma Obj;
    
    public Inf_Preencher_Campos_Relat_Turma(Tela_Relat_Turma parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Relat_Turma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Campos_Relat_Turma dialog = new Inf_Preencher_Campos_Relat_Turma(Obj, true);
