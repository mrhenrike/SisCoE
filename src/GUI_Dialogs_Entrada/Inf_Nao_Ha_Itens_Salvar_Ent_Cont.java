...
public class Inf_Nao_Ha_Itens_Salvar_Ent_Cont extends javax.swing.JDialog {
    
    public static Tela_Entrada_Produto_Cont ObjEntrada;
    
    public Inf_Nao_Ha_Itens_Salvar_Ent_Cont(Tela_Entrada_Produto_Cont parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Nao_Ha_Itens_Salvar_Ent_Cont.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }        
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Nao_Ha_Itens_Salvar_Ent_Cont dialog = new Inf_Nao_Ha_Itens_Salvar_Ent_Cont(ObjEntrada, true);
