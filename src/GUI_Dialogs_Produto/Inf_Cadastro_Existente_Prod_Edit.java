...
public class Inf_Cadastro_Existente_Prod_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Prod_Edit Obj;
    
    public Inf_Cadastro_Existente_Prod_Edit(Tela_Cadastro_Prod_Edit parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Cadastro_Existente_Prod_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        /* Create and display the dialog */
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Cadastro_Existente_Prod_Edit dialog = new Inf_Cadastro_Existente_Prod_Edit(Obj, true);
