...
import GUI_Frames.Tela_Cadastro_Curso_Turma;


public class Inf_Cadastro_Existente_Curso extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Curso_Turma ObjCurso;
    
    public Inf_Cadastro_Existente_Curso(Tela_Cadastro_Curso_Turma parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("O cadastro escolhido já existe!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Cadastro_Existente_Curso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Cadastro_Existente_Curso dialog = new Inf_Cadastro_Existente_Curso(ObjCurso, true);
