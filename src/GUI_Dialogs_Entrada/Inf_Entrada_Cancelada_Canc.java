...
public class Inf_Entrada_Cancelada_Canc extends javax.swing.JDialog {
    
    public static Tela_Cancelar_Entrada_Produto ObjEntrada;
    
    public Inf_Entrada_Cancelada_Canc(Tela_Cancelar_Entrada_Produto parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Essa entrada já foi cancelada!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Entrada_Cancelada_Canc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Entrada_Cancelada_Canc dialog = new Inf_Entrada_Cancelada_Canc(ObjEntrada, true);
