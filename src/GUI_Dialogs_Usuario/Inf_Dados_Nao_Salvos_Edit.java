...
public class Inf_Dados_Nao_Salvos_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Usuario_Edit ObjUserEdit;
    
    public Inf_Dados_Nao_Salvos_Edit(Tela_Cadastro_Usuario_Edit parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Nao_Salvos_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Nao_Salvos_Edit dialog = new Inf_Dados_Nao_Salvos_Edit(ObjUserEdit, true);
