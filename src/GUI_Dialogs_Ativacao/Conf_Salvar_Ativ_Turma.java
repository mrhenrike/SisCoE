...
public class Conf_Salvar_Ativ_Turma extends javax.swing.JDialog {
    
    public static Tela_Ativacao ObjAtiv;
    
    
    public Conf_Salvar_Ativ_Turma(Tela_Ativacao parent, boolean modal) {
        this.ObjAtiv = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Ativ_Turma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Ativ_Turma dialog = new Conf_Salvar_Ativ_Turma(ObjAtiv, true);
