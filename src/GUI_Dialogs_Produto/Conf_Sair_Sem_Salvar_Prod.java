...
public class Conf_Sair_Sem_Salvar_Prod extends javax.swing.JDialog {
    
   public static Tela_Cadastro_Prod ObjProd;
    
    public Conf_Sair_Sem_Salvar_Prod(Tela_Cadastro_Prod parent, boolean modal) {
        this.ObjProd = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Sair_Sem_Salvar_Prod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Sair_Sem_Salvar_Prod dialog = new Conf_Sair_Sem_Salvar_Prod(ObjProd, true);
