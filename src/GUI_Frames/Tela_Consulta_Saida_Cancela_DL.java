...
import GUI_Dialogs_Consulta_Ent_Saida.Inf_Data_Final_Inferior_Cons_Saida_Cancel;
import GUI_Dialogs_Consulta_Ent_Saida.Inf_Nao_Existe_Saida_Cancel;
import GUI_Dialogs_Consulta_Ent_Saida.Inf_Preencher_Datas_Cons_Saida_Cancel;
import GUI_Dialogs_Consulta_Ent_Saida.Inf_Saida_Nao_Encontrada_Cancel;
import GUI_Dialogs_Consulta_Ent_Saida.Inf_Selecione_Linha_Saida_Cancel;
...
public class Tela_Consulta_Saida_Cancela_DL extends javax.swing.JDialog {
    
    Tela_Cancelar_Saida ObjCancelaSaida = new Tela_Cancelar_Saida();
    ...
    private static Inf_Data_Final_Inferior_Cons_Saida_Cancel ObjDataInferior;
    private static Inf_Preencher_Datas_Cons_Saida_Cancel ObjPreencherDatas;
    private static Inf_Saida_Nao_Encontrada_Cancel ObjSaidaNaoEncontrada;
    private static Inf_Selecione_Linha_Saida_Cancel ObjSelecione;
    private static Inf_Nao_Existe_Saida_Cancel ObjNaoExisteSaida;
    
    boolean DataMenor=false;

    public Tela_Consulta_Saida_Cancela_DL(Tela_Cancelar_Saida parent, boolean modal) {
        this.ObjCancelaSaida = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
        setSize(740,530);
        setLocationRelativeTo(ObjCancelaSaida);
    ...
    private void BT_AdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_AdicionarActionPerformed
        ...
        {
            Object id_saida = (JTB_Saidas.getValueAt(JTB_Saidas.getSelectedRow(), 0));
            ObjCancelaSaida.Testar_Campos_Pesquisa(String.valueOf(id_saida));
            dispose();
    ...
    public void Mostrar_Preencher_Datas(){
        ObjPreencherDatas = new Inf_Preencher_Datas_Cons_Saida_Cancel(this, true);
        ObjPreencherDatas.setVisible(true);
    }
    public void Mostrar_Data_Inferior(){
        ObjDataInferior = new Inf_Data_Final_Inferior_Cons_Saida_Cancel(this, true);
    ...
    void Mostrar_Selecione_Uma_Linha(){
        ObjSelecione = new Inf_Selecione_Linha_Saida_Cancel(this, true);
        ObjSelecione.setVisible(true);
    }
    void Mostra_Nao_Existe_Saida(){
        ObjNaoExisteSaida = new Inf_Nao_Existe_Saida_Cancel(this, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Consulta_Saida_Cancela_DL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Tela_Consulta_Saida_Cancela_DL dialog = new Tela_Consulta_Saida_Cancela_DL(new Tela_Cancelar_Saida(), true);
