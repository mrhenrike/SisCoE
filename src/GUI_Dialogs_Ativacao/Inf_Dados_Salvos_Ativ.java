...
public class Inf_Dados_Salvos_Ativ extends javax.swing.JDialog {
    
    public static Tela_Ativacao ObjAtiv;
    
    public Inf_Dados_Salvos_Ativ(Tela_Ativacao parent, boolean modal) {
        this.ObjAtiv = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Os dados foram ativados!");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(49, 49, 49)
                        .addComponent(JB_Ok, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Salvos_Ativ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Salvos_Ativ dialog = new Inf_Dados_Salvos_Ativ(ObjAtiv, true);
