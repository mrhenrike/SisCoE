...
public class Inf_Data_Final_Inferior_Cons_Ent extends javax.swing.JDialog {
    
    public static Tela_Consulta_Entrada ObjRelatEntProd;
    
    public Inf_Data_Final_Inferior_Cons_Ent(Tela_Consulta_Entrada parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Data_Final_Inferior_Cons_Ent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Data_Final_Inferior_Cons_Ent dialog = new Inf_Data_Final_Inferior_Cons_Ent(ObjRelatEntProd, true);
