...
public class Logoff_Adm extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Inicial Obj;
    
    public Logoff_Adm(Tela_Cadastro_Inicial parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Logoff_Adm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Logoff_Adm dialog = new Logoff_Adm(Obj, true);
