...
public class Tela_Relat_Consulta_Produto_Entrada_DL extends javax.swing.JDialog {
 ...
 public final void Setar_Atalho_BT(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Relat_Consulta_Produto_Entrada_DL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Tela_Relat_Consulta_Produto_Entrada_DL dialog = new Tela_Relat_Consulta_Produto_Entrada_DL(new Tela_Relat_Produto_Ent_Periodo(), true);
