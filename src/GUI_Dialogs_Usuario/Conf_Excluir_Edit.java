...
public class Conf_Excluir_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Usuario_Edit ObjUserEdit;
    
    
    public Conf_Excluir_Edit(Tela_Cadastro_Usuario_Edit parent, boolean modal) {
        this.ObjUserEdit = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
        setSize(450,150);
        setLocationRelativeTo(ObjUserEdit);
    }
    ...
    private void initComponents() {
        ...
        setTitle("Confirmação Ao Excluir");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("Tem certeza que deseja excluir os dados?");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icones_Gerais/Lixeira 75x75.png"))); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(JB_Sim, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void JB_NaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_NaoActionPerformed
        dispose();
        ObjUserEdit.Mostrar_Dados_Nao_Salvos();
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
       dispose();
       ObjUserEdit.Conf_Inativar_Usuario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Excluir_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Excluir_Edit dialog = new Conf_Excluir_Edit(ObjUserEdit, true);
