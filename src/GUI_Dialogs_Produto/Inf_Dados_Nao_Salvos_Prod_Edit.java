...
public class Inf_Dados_Nao_Salvos_Prod_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Prod_Edit ObjProd;
    
    public Inf_Dados_Nao_Salvos_Prod_Edit(Tela_Cadastro_Prod_Edit parent, boolean modal) {
        this.ObjProd = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Nao_Salvos_Prod_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Nao_Salvos_Prod_Edit dialog = new Inf_Dados_Nao_Salvos_Prod_Edit(ObjProd, true);
