...
public class Conf_Sair_Sem_Salvar_Categ extends javax.swing.JDialog {
    
   public static Tela_Cadastro_Categoria_DL ObjCategoria;
    
    public Conf_Sair_Sem_Salvar_Categ(Tela_Cadastro_Categoria_DL parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Sair_Sem_Salvar_Categ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Sair_Sem_Salvar_Categ dialog = new Conf_Sair_Sem_Salvar_Categ(ObjCategoria, true);
