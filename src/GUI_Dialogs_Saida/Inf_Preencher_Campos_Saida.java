...
public class Inf_Preencher_Campos_Saida extends javax.swing.JDialog {
    
    public static Tela_Saida_Produto ObjSaida;
    
    public Inf_Preencher_Campos_Saida(Tela_Saida_Produto parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Saida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_Campos_Saida dialog = new Inf_Preencher_Campos_Saida(ObjSaida, true);
