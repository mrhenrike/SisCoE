...
public class Inf_Nao_Existe_Saida extends javax.swing.JDialog {
    
    public static Tela_Consulta_Saida ObjConsSaida;
    
    public Inf_Nao_Existe_Saida(Tela_Consulta_Saida parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Nao_Existe_Saida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Nao_Existe_Saida dialog = new Inf_Nao_Existe_Saida(ObjConsSaida, true);
