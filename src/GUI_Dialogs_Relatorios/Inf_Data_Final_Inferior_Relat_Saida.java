...
public class Inf_Data_Final_Inferior_Relat_Saida extends javax.swing.JDialog {
    
    public static Tela_Relat_Saida_Periodo ObjRelatEntProd;
    
    public Inf_Data_Final_Inferior_Relat_Saida(Tela_Relat_Saida_Periodo parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Data_Final_Inferior_Relat_Saida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Data_Final_Inferior_Relat_Saida dialog = new Inf_Data_Final_Inferior_Relat_Saida(ObjRelatEntProd, true);
