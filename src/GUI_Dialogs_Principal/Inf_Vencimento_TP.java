...
public class Inf_Vencimento_TP extends javax.swing.JDialog {
    
    public static Tela_Principal ObjTP;
    
    
    public Inf_Vencimento_TP(Tela_Principal parent, boolean modal) {
        this.ObjTP = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("abaixo de 30 dias!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Vencimento_TP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Vencimento_TP dialog = new Inf_Vencimento_TP(ObjTP, true);
