...
public class Inf_Saida_Nao_Encontrada_Dev_Outra extends javax.swing.JDialog {
    ...
    public Inf_Saida_Nao_Encontrada_Dev_Outra(Tela_Gerar_Devolucao_Outra parent, boolean modal) {
        this.ObjDev = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Saida_Nao_Encontrada_Dev_Outra dialog = new Inf_Saida_Nao_Encontrada_Dev_Outra(ObjDev, true);
