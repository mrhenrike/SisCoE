...
import GUI_Dialogs_Relatorios.Inf_Data_Final_Inferior_Relat_Saida_Prod;
import GUI_Dialogs_Relatorios.Inf_Preencher_Campos_Relat_Saida_Prod;
import GUI_Dialogs_Relatorios.Inf_Preencher_Datas_Relat_Saida_Prod;
import GUI_Dialogs_Relatorios.Inf_Produto_Nao_Encontrado_Relat_Prod_Saida_Periodo;
...
public class Tela_Relat_Produto_Saida_Periodo extends javax.swing.JInternalFrame {

    public static Tela_Relat_Produto_Saida_Periodo Obj;
    
    public void Open_Tela(){
        if(Obj==null){
            Obj = new Tela_Relat_Produto_Saida_Periodo();
    ...
    private static Inf_Preencher_Datas_Relat_Saida_Prod DLPreencherDatas;
    private static Inf_Data_Final_Inferior_Relat_Saida_Prod DLDataInferior;
    private static Inf_Preencher_Campos_Relat_Saida_Prod DLPreencherCampos;
    private static Tela_Relat_Consulta_Produto_Saida_DL DLConsultaProd;
    private static Inf_Produto_Nao_Encontrado_Relat_Prod_Saida_Periodo DLProdutoNaoEncontrado;

    
    public Tela_Relat_Produto_Saida_Periodo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("34 - Produto Por Saída No Período");
            ...
            if(JD_Inicial.getDate()==null || JD_Final.getDate()==null){
                ...
                if(data_menor == true){
                    ...
                    if(ObjControleProd.Confirma_Existente == true){
                        ObjControleRelatProd.Relatorio_Produto_Saida_Periodo(JD_Inicial, JD_Final,cod_produto);
                        ...
                        new Controle_Log().Registrar_Log("Gerou o relatório de saídas do produto id: "+JL_Id_Desc_Prod.getText()+" - por período de "+dti+" até "+dtf, CodLogado);
                    }else{
    ...
    public void Mostrar_Preencher_Datas(){
        DLPreencherDatas = new Inf_Preencher_Datas_Relat_Saida_Prod(this, true);
        DLPreencherDatas.setVisible(true);
    }
    public void Mostrar_Data_Inferior(){
        DLDataInferior = new Inf_Data_Final_Inferior_Relat_Saida_Prod(this, true);
        DLDataInferior.setVisible(true);
    }
    public void Mostrar_Preencher_Campos(){
        DLPreencherCampos = new Inf_Preencher_Campos_Relat_Saida_Prod(this, true);
        DLPreencherCampos.setVisible(true);
    }
    void Mostrar_Consulta_Produto(){
        DLConsultaProd = new Tela_Relat_Consulta_Produto_Saida_DL(this, true);
        DLConsultaProd.setVisible(true);
    }
    void Mostrar_Produto_Nao_Encontrado(){
        DLProdutoNaoEncontrado = new Inf_Produto_Nao_Encontrado_Relat_Prod_Saida_Periodo(this, true);
