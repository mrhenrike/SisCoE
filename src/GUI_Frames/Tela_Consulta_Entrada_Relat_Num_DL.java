...
public class Tela_Consulta_Entrada_Relat_Num_DL extends javax.swing.JDialog {

    Conecta_Banco ObjConecta = new Conecta_Banco();
    Tela_Relat_Entrada_Num ObjRelatEntrada = new Tela_Relat_Entrada_Num();
    ...
    public Tela_Consulta_Entrada_Relat_Num_DL(Tela_Relat_Entrada_Num parent, boolean modal) {
        this.ObjRelatEntrada = parent;
        this.setModal(modal);
        
        initComponents();
        setResizable(false);
        setSize(815,530);
        setLocationRelativeTo(ObjRelatEntrada);
    ...
    private void JTB_EntradasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTB_EntradasMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            ObjRelatEntrada.Setar_Campo_Num_Entrada(String.valueOf(resultado));
            dispose();
        }
 ...
 public final void Setar_Atalho_BT(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Consulta_Entrada_Relat_Num_DL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Tela_Consulta_Entrada_Relat_Num_DL dialog = new Tela_Consulta_Entrada_Relat_Num_DL(new Tela_Relat_Entrada_Num(), true);
