...
public class Inf_Nao_Existe_Linha_Ent extends javax.swing.JDialog {
    
    public static Tela_Entrada_Produto ObjEntrada;
    
    public Inf_Nao_Existe_Linha_Ent(Tela_Entrada_Produto parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Nao_Existe_Linha_Ent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Nao_Existe_Linha_Ent dialog = new Inf_Nao_Existe_Linha_Ent(ObjEntrada, true);
