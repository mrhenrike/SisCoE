...
public class Conf_Cancelar_Categ1 extends javax.swing.JDialog {
    ...
    public Conf_Cancelar_Categ1(Tela_Cadastro_Categoria_DL1 parent, boolean modal) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(JB_Nao, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(28, 28, 28))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(16, 16, 16)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Cancelar_Categ1 dialog = new Conf_Cancelar_Categ1(ObjCategoria, true);
