...
public class Inf_Nao_Existe_Entrada extends javax.swing.JDialog {
    
    public static Tela_Consulta_Entrada ObjConsEnt;
    
    public Inf_Nao_Existe_Entrada(Tela_Consulta_Entrada parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Não existe entrada realizada!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Nao_Existe_Entrada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Nao_Existe_Entrada dialog = new Inf_Nao_Existe_Entrada(ObjConsEnt, true);
