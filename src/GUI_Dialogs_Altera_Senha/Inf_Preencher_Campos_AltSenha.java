...
public class Inf_Preencher_Campos_AltSenha extends javax.swing.JDialog {
    
    public static Tela_Alterar_Senha ObjAletraSenha;
    
    public Inf_Preencher_Campos_AltSenha(Tela_Alterar_Senha parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_AltSenha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_Campos_AltSenha dialog = new Inf_Preencher_Campos_AltSenha(ObjAletraSenha, true);
