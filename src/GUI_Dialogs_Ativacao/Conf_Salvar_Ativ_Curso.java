...
public class Conf_Salvar_Ativ_Curso extends javax.swing.JDialog {
    
    public static Tela_Ativacao ObjAtiv;
    
    
    public Conf_Salvar_Ativ_Curso(Tela_Ativacao parent, boolean modal) {
        this.ObjAtiv = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Ativ_Curso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Ativ_Curso dialog = new Conf_Salvar_Ativ_Curso(ObjAtiv, true);
