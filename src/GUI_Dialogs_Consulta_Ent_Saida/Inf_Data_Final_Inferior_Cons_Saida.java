...
public class Inf_Data_Final_Inferior_Cons_Saida extends javax.swing.JDialog {
    
    public static Tela_Consulta_Saida ObjConsSaida;
    
    public Inf_Data_Final_Inferior_Cons_Saida(Tela_Consulta_Saida parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Data_Final_Inferior_Cons_Saida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Data_Final_Inferior_Cons_Saida dialog = new Inf_Data_Final_Inferior_Cons_Saida(ObjConsSaida, true);
