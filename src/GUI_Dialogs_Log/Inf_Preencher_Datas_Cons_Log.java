package GUI_Dialogs_Log;

// @author Márison Tamiarana

import GUI_Frames.Tela_Consulta_Log;


public class Inf_Preencher_Datas_Cons_Log extends javax.swing.JDialog {
    
    public static Tela_Consulta_Log Obj;
    
    public Inf_Preencher_Datas_Cons_Log(Tela_Consulta_Log parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Datas_Cons_Log.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Datas_Cons_Log dialog = new Inf_Preencher_Datas_Cons_Log(Obj, true);
