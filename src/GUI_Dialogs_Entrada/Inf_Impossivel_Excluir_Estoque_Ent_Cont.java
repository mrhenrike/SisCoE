...
public class Inf_Impossivel_Excluir_Estoque_Ent_Cont extends javax.swing.JDialog {
    
    public static Tela_Entrada_Produto_Cont ObjEntrada;
    
    public Inf_Impossivel_Excluir_Estoque_Ent_Cont(Tela_Entrada_Produto_Cont parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Impossível excluir o item selecionado!");
        ...
        jLabel4.setText("O estoque está abaixo do necessário!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Impossivel_Excluir_Estoque_Ent_Cont.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Impossivel_Excluir_Estoque_Ent_Cont dialog = new Inf_Impossivel_Excluir_Estoque_Ent_Cont(ObjEntrada, true);
