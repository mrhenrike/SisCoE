...
public class Inf_Cadastro_Existente_User_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Usuario_Edit ObjUser;
    
    public Inf_Cadastro_Existente_User_Edit(Tela_Cadastro_Usuario_Edit parent, boolean modal) {
        this.ObjUser = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Cadastro_Existente_User_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Cadastro_Existente_User_Edit dialog = new Inf_Cadastro_Existente_User_Edit(ObjUser, true);
