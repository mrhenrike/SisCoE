...
public class Conf_Limpar_Campos_Usuario extends javax.swing.JDialog {
 
    private static Tela_Cadastro_Usuario ObjUser;
    
    public Conf_Limpar_Campos_Usuario(Tela_Cadastro_Usuario parent, boolean modal) {
        this.ObjUser = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        setTitle("Confirmação Ao Limpar Campos");
        setMinimumSize(new java.awt.Dimension(450, 100));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("Tem certeza que deseja limpar os dados?");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icones_Gerais/Limpar 75X75.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Limpar_Campos_Usuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Limpar_Campos_Usuario dialog = new Conf_Limpar_Campos_Usuario(ObjUser, true);
