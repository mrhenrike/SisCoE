...
public class Inf_Senha_Invalida_Bloqueio extends javax.swing.JDialog {
    
    public static Tela_Bloqueio Obj;
    
    public Inf_Senha_Invalida_Bloqueio(Tela_Bloqueio parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("A senha do usuário é inválida!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Senha_Invalida_Bloqueio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Senha_Invalida_Bloqueio dialog = new Inf_Senha_Invalida_Bloqueio(Obj, true);
