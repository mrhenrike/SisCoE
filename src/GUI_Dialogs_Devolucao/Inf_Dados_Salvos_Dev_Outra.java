...
public class Inf_Dados_Salvos_Dev_Outra extends javax.swing.JDialog {
    
    public static Tela_Gerar_Devolucao_Outra ObjDev;
    
    public Inf_Dados_Salvos_Dev_Outra(Tela_Gerar_Devolucao_Outra parent, boolean modal) {
        this.ObjDev = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Salvos_Dev_Outra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Dados_Salvos_Dev_Outra dialog = new Inf_Dados_Salvos_Dev_Outra(ObjDev, true);
