...
public class Inf_Log_Nao_Encontrado_Relat_Log extends javax.swing.JDialog {
    
    public static Tela_Relat_Log Obj;
    
    public Inf_Log_Nao_Encontrado_Relat_Log(Tela_Relat_Log parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("O Log não foi encontrado!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Log_Nao_Encontrado_Relat_Log.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Log_Nao_Encontrado_Relat_Log dialog = new Inf_Log_Nao_Encontrado_Relat_Log(Obj, true);
