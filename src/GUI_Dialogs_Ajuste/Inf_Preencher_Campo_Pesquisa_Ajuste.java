...
public class Inf_Preencher_Campo_Pesquisa_Ajuste extends javax.swing.JDialog {
    
    public static Tela_Ajuste_Estoque Obj;
    
    public Inf_Preencher_Campo_Pesquisa_Ajuste(Tela_Ajuste_Estoque parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campo_Pesquisa_Ajuste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_Campo_Pesquisa_Ajuste dialog = new Inf_Preencher_Campo_Pesquisa_Ajuste(Obj, true);
