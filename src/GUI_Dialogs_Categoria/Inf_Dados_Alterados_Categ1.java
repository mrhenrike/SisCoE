...
public class Inf_Dados_Alterados_Categ1 extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Categoria_DL1 ObjCateg;
    
    public Inf_Dados_Alterados_Categ1(Tela_Cadastro_Categoria_DL1 parent, boolean modal) {
        this.ObjCateg = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
        setSize(360,130);
        setLocationRelativeTo(ObjCateg);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Alterados_Categ1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Alterados_Categ1 dialog = new Inf_Dados_Alterados_Categ1(ObjCateg, true);
