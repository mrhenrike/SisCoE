...
public class Tela_Consulta_Produto_Entrada_DL extends javax.swing.JDialog {
    ...
    public Tela_Consulta_Produto_Entrada_DL(Tela_Entrada_Produto parent, boolean modal) {
 ...
 public final void Setar_Atalho_BT(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Consulta_Produto_Entrada_DL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Tela_Consulta_Produto_Entrada_DL dialog = new Tela_Consulta_Produto_Entrada_DL(new Tela_Entrada_Produto(), true);
