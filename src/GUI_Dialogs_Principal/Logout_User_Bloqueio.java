...
public class Logout_User_Bloqueio extends javax.swing.JDialog {
    
    public static Tela_Bloqueio Obj;
    Tela_Principal TP = new Tela_Principal();
    
    public Logout_User_Bloqueio(Tela_Bloqueio parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
        ...
        obj.Registrar_Log("reiniciou o sistema da tela de bloqueio", TP.CodLogado);
        Obj.dispose();
        TP.Reiniciar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Logout_User_Bloqueio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Logout_User_Bloqueio dialog = new Logout_User_Bloqueio(Obj, true);
