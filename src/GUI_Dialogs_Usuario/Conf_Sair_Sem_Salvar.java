...
public class Conf_Sair_Sem_Salvar extends javax.swing.JDialog {
    
   public static Tela_Cadastro_Usuario ObjUser;
    
    public Conf_Sair_Sem_Salvar(Tela_Cadastro_Usuario parent, boolean modal) {
        this.ObjUser = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Sair_Sem_Salvar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Sair_Sem_Salvar dialog = new Conf_Sair_Sem_Salvar(ObjUser, true);
