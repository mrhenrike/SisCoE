...
//        }
    ...
    public final void Preencher_Tabela_Itens_Saida(String SQL) {
        ...
        String[] Colunas = new String[]{"Código", "Descrição","Quantidade","Lote","Validade", "Devolução"};//Seta os indices da tabela
        ObjConecta_2.Conectar();
        ...
        try {
            ...
            do {
                ...
                ObjConecta_2.rs.getDouble("quantidade"), lote, data_val, ObjConecta_2.rs.getString("solicita_devolucao")});
        ...
        JTB_Itens_Saidas.getColumnModel().getColumn(1).setPreferredWidth(300);
        ...
        JTB_Itens_Saidas.getColumnModel().getColumn(3).setPreferredWidth(100);
