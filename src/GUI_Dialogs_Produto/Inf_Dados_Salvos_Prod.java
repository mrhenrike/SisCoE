...
public class Inf_Dados_Salvos_Prod extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Prod ObjProd;
    
    public Inf_Dados_Salvos_Prod(Tela_Cadastro_Prod parent, boolean modal) {
        this.ObjProd = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Salvos_Prod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Salvos_Prod dialog = new Inf_Dados_Salvos_Prod(ObjProd, true);
