...
public class Inf_Nao_Existe_Prod_Dev extends javax.swing.JDialog {
    
    public static Tela_Gerar_Devolucao ObjDev;
    
    public Inf_Nao_Existe_Prod_Dev(Tela_Gerar_Devolucao parent, boolean modal) {
        this.ObjDev = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Não existe produto para devolução!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Nao_Existe_Prod_Dev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Nao_Existe_Prod_Dev dialog = new Inf_Nao_Existe_Prod_Dev(ObjDev, true);
