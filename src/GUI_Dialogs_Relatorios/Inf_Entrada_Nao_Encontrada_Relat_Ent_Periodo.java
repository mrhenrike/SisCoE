...
public class Inf_Entrada_Nao_Encontrada_Relat_Ent_Periodo extends javax.swing.JDialog {
    
    public static Tela_Relat_Entrada_Periodo Obj;
    
    public Inf_Entrada_Nao_Encontrada_Relat_Ent_Periodo(Tela_Relat_Entrada_Periodo parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nenhuma entrada encontrada no período!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Entrada_Nao_Encontrada_Relat_Ent_Periodo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Entrada_Nao_Encontrada_Relat_Ent_Periodo dialog = new Inf_Entrada_Nao_Encontrada_Relat_Ent_Periodo(Obj, true);
