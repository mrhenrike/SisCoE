...
public class Inf_Senhas_Diferentes_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Usuario_Edit ObjUserEdit;
    
    public Inf_Senhas_Diferentes_Edit(Tela_Cadastro_Usuario_Edit parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Senhas digitadas diferentes!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Senhas_Diferentes_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Senhas_Diferentes_Edit dialog = new Inf_Senhas_Diferentes_Edit(ObjUserEdit, true);
