...
public class Tela_Consulta_Produto_Copiar_DL extends javax.swing.JDialog {
    ...
    public Tela_Consulta_Produto_Copiar_DL(Tela_Cadastro_Prod parent, boolean modal) {
        ...
        Setar_Pesquisa(ObjCadProd.Pesquisa);
    ...
    public void Carregar_Dados_Produtos(Object LinhaSelecionada) throws SQLException {               
        ObjCadProd.Carregar_Dados_Produtos(LinhaSelecionada);
} 
 ...
 public final void Setar_Atalho_BT(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Consulta_Produto_Copiar_DL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Tela_Consulta_Produto_Copiar_DL dialog = new Tela_Consulta_Produto_Copiar_DL(new Tela_Cadastro_Prod(), true);
