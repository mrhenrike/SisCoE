...
public class Inf_Nao_Ha_Itens_Ativar extends javax.swing.JDialog {
    
    public static Tela_Ativacao ObjAtiv;
    
    public Inf_Nao_Ha_Itens_Ativar(Tela_Ativacao parent, boolean modal) {
        this.ObjAtiv = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Não há iten para ativar!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Nao_Ha_Itens_Ativar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        /* Create and display the dialog */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Nao_Ha_Itens_Ativar dialog = new Inf_Nao_Ha_Itens_Ativar(ObjAtiv, true);
