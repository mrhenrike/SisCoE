...
public class Inf_Saida_Nao_Encontrada_Relat_Saida_Turma extends javax.swing.JDialog {
    
    public static Tela_Relat_Saida_Turma Obj;
    
    public Inf_Saida_Nao_Encontrada_Relat_Saida_Turma(Tela_Relat_Saida_Turma parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Saida_Nao_Encontrada_Relat_Saida_Turma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Saida_Nao_Encontrada_Relat_Saida_Turma dialog = new Inf_Saida_Nao_Encontrada_Relat_Saida_Turma(Obj, true);
