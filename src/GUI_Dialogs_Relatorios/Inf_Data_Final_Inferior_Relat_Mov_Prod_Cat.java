...
public class Inf_Data_Final_Inferior_Relat_Mov_Prod_Cat extends javax.swing.JDialog {
    
    public static Tela_Relat_Mov_Prod_Periodo_Categoria ObjRelatEntProd;
    
    public Inf_Data_Final_Inferior_Relat_Mov_Prod_Cat(Tela_Relat_Mov_Prod_Periodo_Categoria parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Data_Final_Inferior_Relat_Mov_Prod_Cat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Data_Final_Inferior_Relat_Mov_Prod_Cat dialog = new Inf_Data_Final_Inferior_Relat_Mov_Prod_Cat(ObjRelatEntProd, true);
