...
public class Conf_Alterar_Quant_Saida extends javax.swing.JDialog {
    ...
    public Conf_Alterar_Quant_Saida(Tela_Saida_Produto parent, boolean modal, int linha) {
    ...
    private Conf_Alterar_Quant_Saida(Tela_Saida_Produto ObjSaida, boolean b) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("O produto já existe na linha");
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
        dispose();
        ObjSaida.Mostrar_Nova_Quantidade();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Alterar_Quant_Saida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Alterar_Quant_Saida dialog = new Conf_Alterar_Quant_Saida(ObjSaida, true);
