...
public class Inf_Dados_Salvos_Curso extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Curso_Turma ObjCurso;
    
    public Inf_Dados_Salvos_Curso(Tela_Cadastro_Curso_Turma parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Os dados foram salvos!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Salvos_Curso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Salvos_Curso dialog = new Inf_Dados_Salvos_Curso(ObjCurso, true);
