...
public class Inf_Dados_Nao_Salvos_Turma_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Turma_Edit ObjCurso;
    
    public Inf_Dados_Nao_Salvos_Turma_Edit(Tela_Cadastro_Turma_Edit parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Nao_Salvos_Turma_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Dados_Nao_Salvos_Turma_Edit dialog = new Inf_Dados_Nao_Salvos_Turma_Edit(ObjCurso, true);
