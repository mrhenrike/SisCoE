...
public class Inf_Selecione_Linha_Saida extends javax.swing.JDialog {
    
    public static Tela_Saida_Produto ObjSaida;
    
    public Inf_Selecione_Linha_Saida(Tela_Saida_Produto parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Selecione_Linha_Saida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Selecione_Linha_Saida dialog = new Inf_Selecione_Linha_Saida(ObjSaida, true);
