...
public class Inf_Preencher_Fabricacao extends javax.swing.JDialog {
    
    public static Tela_Entrada_Produto ObjEntradaProd;
    
    public Inf_Preencher_Fabricacao(Tela_Entrada_Produto parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Fabricacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Fabricacao dialog = new Inf_Preencher_Fabricacao(ObjEntradaProd, true);
