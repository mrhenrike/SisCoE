...
public class Inf_Dados_Nao_Salvos_Ent extends javax.swing.JDialog {
    
    public static Tela_Entrada_Produto ObjEntrada;
    
    public Inf_Dados_Nao_Salvos_Ent(Tela_Entrada_Produto parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Nao_Salvos_Ent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Nao_Salvos_Ent dialog = new Inf_Dados_Nao_Salvos_Ent(ObjEntrada, true);
