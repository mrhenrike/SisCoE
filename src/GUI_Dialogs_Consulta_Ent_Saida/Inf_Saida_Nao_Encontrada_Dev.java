...
public class Inf_Saida_Nao_Encontrada_Dev extends javax.swing.JDialog {
    
    public static Tela_Consulta_Saida_Devolucao_DL ObjConsSaida;
    
    public Inf_Saida_Nao_Encontrada_Dev(Tela_Consulta_Saida_Devolucao_DL parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Saida_Nao_Encontrada_Dev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Saida_Nao_Encontrada_Dev dialog = new Inf_Saida_Nao_Encontrada_Dev(ObjConsSaida, true);
