...
import GUI_Frames.Tela_Relat_Saida_Disciplina;

public class Inf_Preencher_Datas_Relat_Saida_Disciplina extends javax.swing.JDialog {
    
    public static Tela_Relat_Saida_Disciplina ObjRelatEntProd;
    
    public Inf_Preencher_Datas_Relat_Saida_Disciplina(Tela_Relat_Saida_Disciplina parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Datas_Relat_Saida_Disciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Datas_Relat_Saida_Disciplina dialog = new Inf_Preencher_Datas_Relat_Saida_Disciplina(ObjRelatEntProd, true);
