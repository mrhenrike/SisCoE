...
public class Tela_Consulta_Saida_Cancela_DL2 extends javax.swing.JDialog {
    ...
    public Tela_Consulta_Saida_Cancela_DL2(Tela_Cancelar_Saida parent, boolean modal) {
        ...
        Contar_Saidas();
        Setar_Pesquisa(ObjCancelaSaida.pesquisa_saida);
        FiltrarNome();
        Setar_Atalho_BT();
        ...
        try {
            ...
            if(ObjControleEntrada.Controle_Entrada == true){
                ...
                Preencher_Tabela("select * from saida where "
                        ...
                        + " and data_saida between '"+di+"' and '"+df+"' and situacao != 'CANCELADA' order by id_saida desc");
 ...
 public final void Setar_Atalho_BT(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Consulta_Saida_Cancela_DL2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Tela_Consulta_Saida_Cancela_DL2 dialog = new Tela_Consulta_Saida_Cancela_DL2(new Tela_Cancelar_Saida(), true);
