...
public class Logout_User_TP extends javax.swing.JDialog {
    
    public static Tela_Principal Obj;    
    
    public Logout_User_TP(Tela_Principal parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        setTitle("Confirmação De Logout De Usuário");
        setUndecorated(true);
        ...
        jLabel4.setText("Tem certeza que deseja fazer logout?");
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
        ...
        obj.Registrar_Log("reiniciou o sistema", Obj.CodLogado);
        Obj.Reiniciar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Logout_User_TP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Logout_User_TP dialog = new Logout_User_TP(Obj, true);
