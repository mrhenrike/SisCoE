...
import GUI_Dialogs_Relatorios.Inf_Data_Final_Inferior_Relat_Mov_Prod;
import GUI_Dialogs_Relatorios.Inf_Preencher_Datas_Relat_Mov_Prod;
...
public class Tela_Relat_Mov_Prod_Periodo extends javax.swing.JInternalFrame {
    
     public static Tela_Relat_Mov_Prod_Periodo Obj;
    
    public void Open_Tela(){
        if(Obj==null){
            Obj = new Tela_Relat_Mov_Prod_Periodo();
    ...
    private static Inf_Preencher_Datas_Relat_Mov_Prod ObjPreencherDatas;
    private static Inf_Data_Final_Inferior_Relat_Mov_Prod ObjDataInferior;
    
    public Tela_Relat_Mov_Prod_Periodo() {
        initComponents();
        Preencher_CB_Tipo();
        Setar_Atalho_BT();
    }
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("59 - Movimentação De Produto Por Período");
        ...
        if(JD_Inicial.getDate()==null || JD_Final.getDate()==null){
            ...
            if(DataMenor == true){
                ...
                if(JCB_Tipo.getSelectedIndex()==0){
                    ObjRelatProd.Relatorio_Produto_Mov_Entrada_Periodo(JD_Inicial, JD_Final);
                    ...
                    new Controle_Log().Registrar_Log("Gerou o relatório de movimentação de entrada de produto por período de "+dti+" até "+dtf, CodLogado);          
                }                
                if(JCB_Tipo.getSelectedIndex()==1){
                    ObjRelatProd.Relatorio_Produto_Mov_Saida_Periodo(JD_Inicial, JD_Final);
                    String dti = new SimpleDateFormat("dd-MM-yyyy").format(JD_Inicial.getDate());
                    String dtf = new SimpleDateFormat("dd-MM-yyyy").format(JD_Final.getDate());
                    new Controle_Log().Registrar_Log("Gerou o relatório de movimentação de saída de produto por período de "+dti+" até "+dtf, CodLogado);
                }
                if(JCB_Tipo.getSelectedIndex()==2){
                    ObjRelatProd.Relatorio_Produto_Mov_Ajuste_Periodo(JD_Inicial, JD_Final);
                    String dti = new SimpleDateFormat("dd-MM-yyyy").format(JD_Inicial.getDate());
                    String dtf = new SimpleDateFormat("dd-MM-yyyy").format(JD_Final.getDate());
                    new Controle_Log().Registrar_Log("Gerou o relatório de movimentação de Ajuste de estoque de produto por período de "+dti+" até "+dtf, CodLogado);
                }
                if(JCB_Tipo.getSelectedIndex()==3){
                    ObjRelatProd.Relatorio_Produto_Mov_Geral_Periodo(JD_Inicial, JD_Final);
                    String dti = new SimpleDateFormat("dd-MM-yyyy").format(JD_Inicial.getDate());
                    String dtf = new SimpleDateFormat("dd-MM-yyyy").format(JD_Final.getDate());
                    new Controle_Log().Registrar_Log("Gerou o relatório de movimentação geral de produto por período de "+dti+" até "+dtf, CodLogado);
                }
            }
        }
    }
    ...
    public void Mostrar_Preencher_Datas(){
        ObjPreencherDatas = new Inf_Preencher_Datas_Relat_Mov_Prod(this, true);
        ObjPreencherDatas.setVisible(true);
    }
    public void Mostrar_Data_Inferior(){
        ObjDataInferior = new Inf_Data_Final_Inferior_Relat_Mov_Prod(this, true);
