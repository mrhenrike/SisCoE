...
public class Inf_Data_Final_Inferior_Relat_Mov_Prod_Saida_Curso extends javax.swing.JDialog {
    
    public static Tela_Relat_Mov_Prod_Saida_Curso ObjRelatEntProd;
    
    public Inf_Data_Final_Inferior_Relat_Mov_Prod_Saida_Curso(Tela_Relat_Mov_Prod_Saida_Curso parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Data_Final_Inferior_Relat_Mov_Prod_Saida_Curso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Data_Final_Inferior_Relat_Mov_Prod_Saida_Curso dialog = new Inf_Data_Final_Inferior_Relat_Mov_Prod_Saida_Curso(ObjRelatEntProd, true);
