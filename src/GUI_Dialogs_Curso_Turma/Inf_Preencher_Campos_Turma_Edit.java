...
public class Inf_Preencher_Campos_Turma_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Turma_Edit Obj;
    
    public Inf_Preencher_Campos_Turma_Edit(Tela_Cadastro_Turma_Edit parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Turma_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Campos_Turma_Edit dialog = new Inf_Preencher_Campos_Turma_Edit(Obj, true);
