...
import GUI_Dialogs_Relatorios.Inf_Preencher_Campos_Relat_Turma;
...
public class Tela_Relat_Turma extends javax.swing.JInternalFrame {
    
    public static Tela_Relat_Turma Obj;
    
    public void Open_Tela(){
        if(Obj==null){
            Obj = new Tela_Relat_Turma();
    ...
    private static Inf_Preencher_Campos_Relat_Turma ObjPreencherCampos;

    public Tela_Relat_Turma() {
        initComponents();
        Preencher_CB_Tipo();
    ...
    final void Preencher_CB_Tipo(){
         ...
         JCB_Tipo.addItem("POR CURSO COM DISCIPLINAS"); 
     }
    ...
    public void Testar_Campos(){
        ...
        if(JCB_Tipo.getSelectedIndex()<=0 || JCB_Curso.getSelectedIndex()<=0){
            ...
            if((JCB_Tipo.getSelectedIndex()==1) && (JCB_Curso.getSelectedIndex()==1)){
                new Controle_Relatorio_Curso_Turma_Disciplina().Relatorio_Turma(String.valueOf(JY_Ano.getValue()));
                log = "todas as turmas de todos cursos no ano de "+String.valueOf(JY_Ano.getValue());
            }
            if((JCB_Tipo.getSelectedIndex()==1) && (JCB_Curso.getSelectedIndex()>1)){
                ObjControleCurso.Procura_Id_Curso(ObjModCurso, JCB_Curso);
                new Controle_Relatorio_Curso_Turma_Disciplina().Relatorio_Turma_Selecionado_Curso(String.valueOf(JY_Ano.getValue()),ObjModCurso.getId_curso());
                log = "todas as turmas do curso de '"+JCB_Curso.getSelectedItem().toString().trim()+"' no ano de "+String.valueOf(JY_Ano.getValue());
            }
            if((JCB_Tipo.getSelectedIndex()==2) && (JCB_Curso.getSelectedIndex()==1)){
                new Controle_Relatorio_Curso_Turma_Disciplina().Relatorio_Turma_Disciplina(String.valueOf(JY_Ano.getValue()));
                log = "todas as turmas com as disciplinas de todos cursos no ano de "+String.valueOf(JY_Ano.getValue());
            }
            if((JCB_Tipo.getSelectedIndex()==2) && (JCB_Curso.getSelectedIndex()>1)){
                ObjControleCurso.Procura_Id_Curso(ObjModCurso, JCB_Curso);
                new Controle_Relatorio_Curso_Turma_Disciplina().Relatorio_Turma_Disciplina_Selecionado_Curso(String.valueOf(JY_Ano.getValue()),ObjModCurso.getId_curso());
                log = "todas as turmas com as disciplina do curso de '"+JCB_Curso.getSelectedItem().toString().trim()+"' no ano de "+String.valueOf(JY_Ano.getValue());
            }
    ...
    public void Mostrar_Preencher_Campos(){
        ObjPreencherCampos = new Inf_Preencher_Campos_Relat_Turma(this, true);
