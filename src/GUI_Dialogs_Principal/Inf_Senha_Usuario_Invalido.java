...
public class Inf_Senha_Usuario_Invalido extends javax.swing.JDialog {
    
    public static Tela_Login ObjProd;
    
    public Inf_Senha_Usuario_Invalido(Tela_Login parent, boolean modal) {
        this.ObjProd = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Usuário e/ou senha inválida!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Senha_Usuario_Invalido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Senha_Usuario_Invalido dialog = new Inf_Senha_Usuario_Invalido(ObjProd, true);
