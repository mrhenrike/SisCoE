...
public class Inf_Dados_Salvos_Saida_Cancel extends javax.swing.JDialog {
    
    public static Tela_Cancelar_Saida ObjSaida;
    
    public Inf_Dados_Salvos_Saida_Cancel(Tela_Cancelar_Saida parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("A saída foi cancelada com sucesso!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Salvos_Saida_Cancel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Dados_Salvos_Saida_Cancel dialog = new Inf_Dados_Salvos_Saida_Cancel(ObjSaida, true);
