...
import GUI_Frames.Tela_Consulta_Entrada;
// @author Márison Tamiarana


public class Inf_Preencher_N_Entrada_Cons_Ent extends javax.swing.JDialog {
    
    public static Tela_Consulta_Entrada ObjRelatEnt;
    
    public Inf_Preencher_N_Entrada_Cons_Ent(Tela_Consulta_Entrada parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Preencher campo Nº da entrada!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_N_Entrada_Cons_Ent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_N_Entrada_Cons_Ent dialog = new Inf_Preencher_N_Entrada_Cons_Ent(ObjRelatEnt, true);
