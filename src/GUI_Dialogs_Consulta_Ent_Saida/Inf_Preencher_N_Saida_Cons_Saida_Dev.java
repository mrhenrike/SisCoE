...
import GUI_Frames.Tela_Consulta_Saida_Devolucao_DL;
// @author Márison Tamiarana


public class Inf_Preencher_N_Saida_Cons_Saida_Dev extends javax.swing.JDialog {
    
    public static Tela_Consulta_Saida_Devolucao_DL ObjConsSaida;
    
    public Inf_Preencher_N_Saida_Cons_Saida_Dev(Tela_Consulta_Saida_Devolucao_DL parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Preencher campo Nº da saída!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_N_Saida_Cons_Saida_Dev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_N_Saida_Cons_Saida_Dev dialog = new Inf_Preencher_N_Saida_Cons_Saida_Dev(ObjConsSaida, true);
