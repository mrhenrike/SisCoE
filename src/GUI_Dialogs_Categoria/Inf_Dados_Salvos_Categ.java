...
public class Inf_Dados_Salvos_Categ extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Categoria_DL ObjCateg;
    
    public Inf_Dados_Salvos_Categ(Tela_Cadastro_Categoria_DL parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Salvos_Categ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Salvos_Categ dialog = new Inf_Dados_Salvos_Categ(ObjCateg, true);
