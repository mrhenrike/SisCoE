...
import GUI_Frames.Tela_Cadastro_Curso_Edit;


public class Conf_Salvar_Curso_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Curso_Edit ObjCurso;
    
    
    public Conf_Salvar_Curso_Edit(Tela_Cadastro_Curso_Edit parent, boolean modal) {
        this.ObjCurso = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
        setSize(450,130);
        setLocationRelativeTo(ObjCurso);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tem certeza que deseja alterar os dados?");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(JB_Sim, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(JB_Nao, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void JB_NaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_NaoActionPerformed
       dispose();
       ObjCurso.Mostrar_Dados_Nao_Salvos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Curso_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Curso_Edit dialog = new Conf_Salvar_Curso_Edit(ObjCurso, true);
