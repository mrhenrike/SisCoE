...
import GUI_Frames.Tela_Cadastro_Usuario;


public class Conf_Salvar extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Usuario ObjUsuario;
    
    
    public Conf_Salvar(Tela_Cadastro_Usuario parent, boolean modal) {
        this.ObjUsuario = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
        setSize(450,130);
        setLocationRelativeTo(ObjUsuario);
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(JB_Sim, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(JB_Nao, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
       dispose();
       ObjUsuario.Conf_Inserir_Usario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar dialog = new Conf_Salvar(ObjUsuario, true);
