...
public class Inf_Cadastro_Existente_Curso_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Curso_Edit ObjCategoria;
    
    public Inf_Cadastro_Existente_Curso_Edit(Tela_Cadastro_Curso_Edit parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Cadastro_Existente_Curso_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Cadastro_Existente_Curso_Edit dialog = new Inf_Cadastro_Existente_Curso_Edit(ObjCategoria, true);
