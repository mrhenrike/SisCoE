...
public class Inf_Senhas_Diferentes extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Usuario ObjUser;
    
    public Inf_Senhas_Diferentes(Tela_Cadastro_Usuario parent, boolean modal) {
        this.ObjUser = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Senhas_Diferentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Senhas_Diferentes dialog = new Inf_Senhas_Diferentes(ObjUser, true);
