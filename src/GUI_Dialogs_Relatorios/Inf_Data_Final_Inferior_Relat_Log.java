...
public class Inf_Data_Final_Inferior_Relat_Log extends javax.swing.JDialog {
    
    public static Tela_Relat_Log ObjRelatEntProd;
    
    public Inf_Data_Final_Inferior_Relat_Log(Tela_Relat_Log parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Data_Final_Inferior_Relat_Log.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Data_Final_Inferior_Relat_Log dialog = new Inf_Data_Final_Inferior_Relat_Log(ObjRelatEntProd, true);
