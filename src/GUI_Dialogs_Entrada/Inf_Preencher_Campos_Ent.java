...
public class Inf_Preencher_Campos_Ent extends javax.swing.JDialog {
    
    public static Tela_Entrada_Produto ObjEntradaProd;
    
    public Inf_Preencher_Campos_Ent(Tela_Entrada_Produto parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Ent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_Campos_Ent dialog = new Inf_Preencher_Campos_Ent(ObjEntradaProd, true);
