...
public class Inf_Data_Final_Inferior_Cons_Saida_Cancel extends javax.swing.JDialog {
    
    public static Tela_Consulta_Saida_Cancela_DL ObjConsSaida;
    
    public Inf_Data_Final_Inferior_Cons_Saida_Cancel(Tela_Consulta_Saida_Cancela_DL parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Data_Final_Inferior_Cons_Saida_Cancel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Data_Final_Inferior_Cons_Saida_Cancel dialog = new Inf_Data_Final_Inferior_Cons_Saida_Cancel(ObjConsSaida, true);
