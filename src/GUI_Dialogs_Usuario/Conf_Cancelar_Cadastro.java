...
public class Conf_Cancelar_Cadastro extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Usuario ObjUser;
    
    public Conf_Cancelar_Cadastro(Tela_Cadastro_Usuario parent, boolean modal) {
        this.ObjUser = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Cancelar_Cadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Cancelar_Cadastro dialog = new Conf_Cancelar_Cadastro(ObjUser, true);
