...
public class Conf_Salvar_Categoria extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Categoria_DL ObjCategoria;
    
    
    public Conf_Salvar_Categoria(Tela_Cadastro_Categoria_DL parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Categoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Categoria dialog = new Conf_Salvar_Categoria(ObjCategoria, true);
