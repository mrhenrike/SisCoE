...
public class Inf_Preencher_Campos_Saida_Cancel extends javax.swing.JDialog {
    
    public static Tela_Cancelar_Saida ObjSaida;
    
    public Inf_Preencher_Campos_Saida_Cancel(Tela_Cancelar_Saida parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Saida_Cancel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Campos_Saida_Cancel dialog = new Inf_Preencher_Campos_Saida_Cancel(ObjSaida, true);
