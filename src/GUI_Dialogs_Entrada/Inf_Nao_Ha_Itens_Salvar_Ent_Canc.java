...
public class Inf_Nao_Ha_Itens_Salvar_Ent_Canc extends javax.swing.JDialog {
    
    public static Tela_Cancelar_Entrada_Produto ObjEntrada;
    
    public Inf_Nao_Ha_Itens_Salvar_Ent_Canc(Tela_Cancelar_Entrada_Produto parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Não há itens para salvar!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Nao_Ha_Itens_Salvar_Ent_Canc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }        
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Nao_Ha_Itens_Salvar_Ent_Canc dialog = new Inf_Nao_Ha_Itens_Salvar_Ent_Canc(ObjEntrada, true);
