...
public class Inf_Produto_Nao_Encontrado_Relat_Prod_Ent_Periodo extends javax.swing.JDialog {
    
    public static Tela_Relat_Produto_Ent_Periodo Obj;
    
    public Inf_Produto_Nao_Encontrado_Relat_Prod_Ent_Periodo(Tela_Relat_Produto_Ent_Periodo parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Produto_Nao_Encontrado_Relat_Prod_Ent_Periodo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Produto_Nao_Encontrado_Relat_Prod_Ent_Periodo dialog = new Inf_Produto_Nao_Encontrado_Relat_Prod_Ent_Periodo(Obj, true);
