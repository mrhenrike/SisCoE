...
public class Inf_Selecione_Linha_Saida_Cancel extends javax.swing.JDialog {
    
    public static Tela_Consulta_Saida_Cancela_DL ObjSaida;
    
    public Inf_Selecione_Linha_Saida_Cancel(Tela_Consulta_Saida_Cancela_DL parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecione uma linha!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Selecione_Linha_Saida_Cancel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Selecione_Linha_Saida_Cancel dialog = new Inf_Selecione_Linha_Saida_Cancel(ObjSaida, true);
