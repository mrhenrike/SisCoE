...
public class Conf_Sair_Sem_Salvar_Curso_Edit extends javax.swing.JDialog {
    
   public static Tela_Cadastro_Curso_Edit ObjCurso;
    
    public Conf_Sair_Sem_Salvar_Curso_Edit(Tela_Cadastro_Curso_Edit parent, boolean modal) {
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
       new Controle_Log().Registrar_Log("cancelou a edição do curso id: "+ObjCurso.id_curso_edit+" - "+ObjCurso.curso_edit, CodLogado);
       ObjCurso.dispose();
       dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Sair_Sem_Salvar_Curso_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Conf_Sair_Sem_Salvar_Curso_Edit dialog = new Conf_Sair_Sem_Salvar_Curso_Edit(ObjCurso, true);
