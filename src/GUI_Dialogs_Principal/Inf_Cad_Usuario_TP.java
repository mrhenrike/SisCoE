...
public class Inf_Cad_Usuario_TP extends javax.swing.JDialog {
    
    public static Tela_Principal ObjTP;
    
    
    public Inf_Cad_Usuario_TP(Tela_Principal parent, boolean modal) {
        this.ObjTP = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Favor, cadastre um usuário");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Cad_Usuario_TP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }      
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Cad_Usuario_TP dialog = new Inf_Cad_Usuario_TP(ObjTP, true);
