...
public class Inf_Saida_Nao_Encontrada_Cancel extends javax.swing.JDialog {
    ...
    public Inf_Saida_Nao_Encontrada_Cancel(Tela_Cancelar_Saida parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("A saída não foi encontrada!");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Saida_Nao_Encontrada_Cancel dialog = new Inf_Saida_Nao_Encontrada_Cancel(ObjSaida, true);
