...
public class Conf_Sair_Sem_Salvar_AltSenha extends javax.swing.JDialog {
    
   public static Tela_Alterar_Senha ObjAlteraSenha;
    
    public Conf_Sair_Sem_Salvar_AltSenha(Tela_Alterar_Senha parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deseja cancelar as alterações?");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(JB_Sim, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(JB_Nao, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Sair_Sem_Salvar_AltSenha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Sair_Sem_Salvar_AltSenha dialog = new Conf_Sair_Sem_Salvar_AltSenha(ObjAlteraSenha, true);
