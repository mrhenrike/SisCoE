...
public class Conf_Salvar_Curso extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Curso_Turma ObjCurso;
    
    
    public Conf_Salvar_Curso(Tela_Cadastro_Curso_Turma parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Curso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Curso dialog = new Conf_Salvar_Curso(ObjCurso, true);
