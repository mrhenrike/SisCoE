...
public class Inf_Produto_Existente_Lote_Ent_Cont extends javax.swing.JDialog {
    
    public static Tela_Entrada_Produto_Cont ObjEntrada;
    
    public Inf_Produto_Existente_Lote_Ent_Cont(Tela_Entrada_Produto_Cont parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Produto_Existente_Lote_Ent_Cont.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        /* Create and display the dialog */
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Produto_Existente_Lote_Ent_Cont dialog = new Inf_Produto_Existente_Lote_Ent_Cont(ObjEntrada, true);
