...
public class Inf_Preencher_Campos_Curso_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Curso_Edit ObjCurso;
    
    public Inf_Preencher_Campos_Curso_Edit(Tela_Cadastro_Curso_Edit parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Curso_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Campos_Curso_Edit dialog = new Inf_Preencher_Campos_Curso_Edit(ObjCurso, true);
