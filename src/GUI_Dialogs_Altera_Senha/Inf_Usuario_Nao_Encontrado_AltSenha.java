...
public class Inf_Usuario_Nao_Encontrado_AltSenha extends javax.swing.JDialog {
    
    public static Tela_Alterar_Senha ObjAlteraSenha;
    
    public Inf_Usuario_Nao_Encontrado_AltSenha(Tela_Alterar_Senha parent, boolean modal) {
    ...
    private void JB_Ok2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_Ok2ActionPerformed
        dispose();
    }//GEN-LAST:event_JB_Ok2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Usuario_Nao_Encontrado_AltSenha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Usuario_Nao_Encontrado_AltSenha dialog = new Inf_Usuario_Nao_Encontrado_AltSenha(ObjAlteraSenha, true);
