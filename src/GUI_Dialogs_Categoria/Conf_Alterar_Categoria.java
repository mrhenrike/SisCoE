...
public class Conf_Alterar_Categoria extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Categoria_DL ObjCategoria;
    
    
    public Conf_Alterar_Categoria(Tela_Cadastro_Categoria_DL parent, boolean modal) {
    ...
    private void JB_NaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_NaoActionPerformed
       dispose();
       ObjCategoria.Mostrar_Dados_Nao_Alterados();
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
       dispose();
       ObjCategoria.Conf_Alterar_Categoria();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Alterar_Categoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Alterar_Categoria dialog = new Conf_Alterar_Categoria(ObjCategoria, true);
