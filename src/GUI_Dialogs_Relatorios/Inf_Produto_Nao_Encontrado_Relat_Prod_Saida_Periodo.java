...
import GUI_Frames.Tela_Relat_Produto_Saida_Periodo;


public class Inf_Produto_Nao_Encontrado_Relat_Prod_Saida_Periodo extends javax.swing.JDialog {
    
    public static Tela_Relat_Produto_Saida_Periodo Obj;
    
    public Inf_Produto_Nao_Encontrado_Relat_Prod_Saida_Periodo(Tela_Relat_Produto_Saida_Periodo parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("O produto não foi encontrado!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Produto_Nao_Encontrado_Relat_Prod_Saida_Periodo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Produto_Nao_Encontrado_Relat_Prod_Saida_Periodo dialog = new Inf_Produto_Nao_Encontrado_Relat_Prod_Saida_Periodo(Obj, true);
