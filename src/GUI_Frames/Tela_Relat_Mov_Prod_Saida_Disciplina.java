...
import GUI_Dialogs_Relatorios.Inf_Data_Final_Inferior_Relat_Mov_Prod_Saida_Disciplina;
import GUI_Dialogs_Relatorios.Inf_Preencher_Datas_Relat_Mov_Prod_Saida_Disciplina;
...
public class Tela_Relat_Mov_Prod_Saida_Disciplina extends javax.swing.JInternalFrame {
    
     public static Tela_Relat_Mov_Prod_Saida_Disciplina Obj;
    
    public void Open_Tela(){
        if(Obj==null){
            Obj = new Tela_Relat_Mov_Prod_Saida_Disciplina();
    ...
    private static Inf_Preencher_Datas_Relat_Mov_Prod_Saida_Disciplina ObjPreencherDatas;
    private static Inf_Data_Final_Inferior_Relat_Mov_Prod_Saida_Disciplina ObjDataInferior;
    
    String sql_semestre = " ";
    String ano;
    
    public Tela_Relat_Mov_Prod_Saida_Disciplina() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("63 - Movimentação De Produto Por Saída Por Disciplina");
    ...
    private void JCB_SemestreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JCB_SemestreActionPerformed
        if(JCB_Semestre.getSelectedIndex()==0){
            ...
            sql_semestre = " and disciplina.semestre = "+JCB_Semestre.getSelectedItem().toString().trim()+" ";
            Preencher_CB_Disciplinas();
            ano = String.valueOf(JY_Ano.getValue());
            new Controle_Disciplina().Preencher_CB_Disciplina(JCB_Disciplina, sql_semestre, JCB_Curso.getSelectedItem().toString());
            JCB_Disciplina.setSelectedIndex(0);
    ...
    private void JCB_DisciplinaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_JCB_DisciplinaFocusGained
        if(JCB_Disciplina.getSelectedIndex()==0){
            Preencher_CB_Disciplinas();
            ano = String.valueOf(JY_Ano.getValue());
            new Controle_Disciplina().Preencher_CB_Disciplina(JCB_Disciplina, sql_semestre, JCB_Curso.getSelectedItem().toString());
        }
        ...
        if(JD_Inicial.getDate()==null || JD_Final.getDate()==null){
            ...
            if(DataMenor == true){
                ...
                if (JCB_Curso.getSelectedIndex() == 0) {//todas cursos
                    ano = String.valueOf(JY_Ano.getValue());
                    new Controle_Relatorio_Produto().Relatorio_Produto_Mov_Saida_Periodo_Disciplina(JD_Inicial, JD_Final, sql_semestre, ano);                    
                    ...
                    new Controle_Log().Registrar_Log("Gerou o relatório de movimentação de produto por saídas por disciplinas - todas de " + ano + " no período de " + dti + " até " + dtf, CodLogado);
                    ...
                    if (JCB_Disciplina.getSelectedIndex() == 0) {//todas disciplina
                        ...
                        new Controle_Relatorio_Produto().Relatorio_Produto_Mov_Saida_Periodo_Disciplina_Curso_Selecionado(JD_Inicial, JD_Final, sql_semestre, ano,curso);               
                        String dti = new SimpleDateFormat("dd-MM-yyyy").format(JD_Inicial.getDate());
                        String dtf = new SimpleDateFormat("dd-MM-yyyy").format(JD_Final.getDate());
                        new Controle_Log().Registrar_Log("Gerou o relatório de movimentação de produto por saídas por Disciplina - todas de " + ano + " - curso: '" + curso + "' no período de " + dti + " até " + dtf, CodLogado);
                    } else {//disciplina selecionada
                        ano = String.valueOf(JY_Ano.getValue());
                        String curso = JCB_Curso.getSelectedItem().toString().trim();
                        Id_Disciplina();//consulta o id da disciplina
                        new Controle_Relatorio_Produto().Relatorio_Produto_Mov_Saida_Periodo_Disciplina_Selecionada_Curso_Selecionado(JD_Inicial, JD_Final, sql_semestre, ano,curso, ObjModDisciplina.getId_disciplina());               
                        String dti = new SimpleDateFormat("dd-MM-yyyy").format(JD_Inicial.getDate());
                        String dtf = new SimpleDateFormat("dd-MM-yyyy").format(JD_Final.getDate());
    ...
    public void Mostrar_Preencher_Datas(){
        ObjPreencherDatas = new Inf_Preencher_Datas_Relat_Mov_Prod_Saida_Disciplina(this, true);
        ObjPreencherDatas.setVisible(true);
    }
    public void Mostrar_Data_Inferior(){
        ObjDataInferior = new Inf_Data_Final_Inferior_Relat_Mov_Prod_Saida_Disciplina(this, true);
