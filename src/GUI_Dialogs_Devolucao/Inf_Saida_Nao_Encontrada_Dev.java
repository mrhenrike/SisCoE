...
import GUI_Frames.Tela_Gerar_Devolucao;


public class Inf_Saida_Nao_Encontrada_Dev extends javax.swing.JDialog {
    
    public static Tela_Gerar_Devolucao ObjDev;
    
    public Inf_Saida_Nao_Encontrada_Dev(Tela_Gerar_Devolucao parent, boolean modal) {
        this.ObjDev = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Saida_Nao_Encontrada_Dev dialog = new Inf_Saida_Nao_Encontrada_Dev(ObjDev, true);
