...
public class Inf_Dev_Pendente_TP extends javax.swing.JDialog {
    
    public static Tela_Principal ObjTP;
    
    public Inf_Dev_Pendente_TP(Tela_Principal parent, boolean modal) {
        this.ObjTP = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Existe saída com devolução");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dev_Pendente_TP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }      
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Dev_Pendente_TP dialog = new Inf_Dev_Pendente_TP(ObjTP, true);
