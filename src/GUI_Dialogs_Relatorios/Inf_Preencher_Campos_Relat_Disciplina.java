...
import GUI_Frames.Tela_Relat_Disciplina;


public class Inf_Preencher_Campos_Relat_Disciplina extends javax.swing.JDialog {
    
    public static Tela_Relat_Disciplina Obj;
    
    public Inf_Preencher_Campos_Relat_Disciplina(Tela_Relat_Disciplina parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecione os campos obrigatórios!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Relat_Disciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Preencher_Campos_Relat_Disciplina dialog = new Inf_Preencher_Campos_Relat_Disciplina(Obj, true);
