...
public class Inf_Selecione_Linha_Ativar extends javax.swing.JDialog {
    
    public static Tela_Ativacao ObjAtiv;
    
    public Inf_Selecione_Linha_Ativar(Tela_Ativacao parent, boolean modal) {
        this.ObjAtiv = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecione uma linha para ativar!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Selecione_Linha_Ativar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        /* Create and display the dialog */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Selecione_Linha_Ativar dialog = new Inf_Selecione_Linha_Ativar(ObjAtiv, true);
