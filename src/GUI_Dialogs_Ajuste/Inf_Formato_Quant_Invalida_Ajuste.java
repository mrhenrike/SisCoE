...
public class Inf_Formato_Quant_Invalida_Ajuste extends javax.swing.JDialog {
    
    public static Tela_Ajuste_Estoque Obj;
    
    public Inf_Formato_Quant_Invalida_Ajuste(Tela_Ajuste_Estoque parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("O formato da quantidade é invalida!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Formato_Quant_Invalida_Ajuste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Formato_Quant_Invalida_Ajuste dialog = new Inf_Formato_Quant_Invalida_Ajuste(Obj, true);
