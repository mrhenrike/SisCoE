...
public class Inf_Dados_Salvos_Disc_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Disciplina_Edit Obj;
    
    public Inf_Dados_Salvos_Disc_Edit(Tela_Cadastro_Disciplina_Edit parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Salvos_Disc_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Salvos_Disc_Edit dialog = new Inf_Dados_Salvos_Disc_Edit(Obj, true);
