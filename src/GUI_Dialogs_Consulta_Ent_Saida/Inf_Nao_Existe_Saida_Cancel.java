...
public class Inf_Nao_Existe_Saida_Cancel extends javax.swing.JDialog {
    
    public static Tela_Consulta_Saida_Cancela_DL ObjConsSaida;
    
    public Inf_Nao_Existe_Saida_Cancel(Tela_Consulta_Saida_Cancela_DL parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Não existe saída realizada!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Nao_Existe_Saida_Cancel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Nao_Existe_Saida_Cancel dialog = new Inf_Nao_Existe_Saida_Cancel(ObjConsSaida, true);
