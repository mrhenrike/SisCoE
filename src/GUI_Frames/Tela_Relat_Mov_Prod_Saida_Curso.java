...
import GUI_Dialogs_Relatorios.Inf_Data_Final_Inferior_Relat_Mov_Prod_Saida_Curso;
import GUI_Dialogs_Relatorios.Inf_Preencher_Datas_Relat_Mov_Prod_Saida_Curso;
...
public class Tela_Relat_Mov_Prod_Saida_Curso extends javax.swing.JInternalFrame {
    
     public static Tela_Relat_Mov_Prod_Saida_Curso Obj;
    
    public void Open_Tela(){
        if(Obj==null){
            Obj = new Tela_Relat_Mov_Prod_Saida_Curso();
    ...
    private static Inf_Preencher_Datas_Relat_Mov_Prod_Saida_Curso ObjPreencherDatas;
    private static Inf_Data_Final_Inferior_Relat_Mov_Prod_Saida_Curso ObjDataInferior;
    
    public Tela_Relat_Mov_Prod_Saida_Curso() {
        initComponents();
        Preencher_CB_Curso();
        Setar_Atalho_BT();
    }
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("61 - Movimentação De Produto Por Curso Por Período");
        ...
        if(JD_Inicial.getDate()==null || JD_Final.getDate()==null){
            ...
            if(DataMenor == true){
                ...
                if (JCB_Curso.getSelectedIndex() == 0) {//todos cursos                    
                        new Controle_Relatorio_Produto().Relatorio_Produto_Mov_Saida_Periodo_Curso(JD_Inicial, JD_Final);
                        //Log
                        ...
                        new Controle_Log().Registrar_Log("Gerou o relatório de movimentação de produto por curso no período de " + dti + " até " + dtf, CodLogado);
                } else {//curso selecionado  
                    String curso = JCB_Curso.getSelectedItem().toString().trim();
                        new Controle_Relatorio_Produto().Relatorio_Produto_Mov_Saida_Periodo_Curso_Selecionado(JD_Inicial, JD_Final,curso);
                        //Log
                        String dti = new SimpleDateFormat("dd-MM-yyyy").format(JD_Inicial.getDate());
                        String dtf = new SimpleDateFormat("dd-MM-yyyy").format(JD_Final.getDate());
                        new Controle_Log().Registrar_Log("Gerou o relatório de movimentação de produto por curso selecionado '" + curso + "' no período de " + dti + " até " + dtf, CodLogado);
                }                          
            }
        }
    }
    ...
    public void Mostrar_Preencher_Datas(){
        ObjPreencherDatas = new Inf_Preencher_Datas_Relat_Mov_Prod_Saida_Curso(this, true);
        ObjPreencherDatas.setVisible(true);
    }
    public void Mostrar_Data_Inferior(){
        ObjDataInferior = new Inf_Data_Final_Inferior_Relat_Mov_Prod_Saida_Curso(this, true);
