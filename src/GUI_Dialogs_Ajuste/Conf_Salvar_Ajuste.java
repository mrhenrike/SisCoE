...
public class Conf_Salvar_Ajuste extends javax.swing.JDialog {
    
    public static Tela_Ajuste_Estoque Obj;
    
    
    public Conf_Salvar_Ajuste(Tela_Ajuste_Estoque parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deseja efetivar esse ajuste de estoque?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Ajuste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Ajuste dialog = new Conf_Salvar_Ajuste(Obj, true);
