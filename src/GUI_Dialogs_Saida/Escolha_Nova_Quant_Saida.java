...
public class Escolha_Nova_Quant_Saida extends javax.swing.JDialog {
    ...
    public Escolha_Nova_Quant_Saida(Tela_Saida_Produto parent, boolean modal) {
        ...
        JL_QuantSolicitada.setText(String.valueOf(ObjSaida.quantidade_sem_lote));
    ...
    private void initComponents() {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(JL_QuantSolicitada, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        setSize(new java.awt.Dimension(286, 227));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void JB_OkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_OkActionPerformed
        if(!JTF_Quantidade.getText().equalsIgnoreCase("")){
             double QuantSolicitada = Double.parseDouble(JTF_Quantidade.getText().trim());
             double QuantDisponivel  = ObjModeloSaida.getQuantidade();
             if(QuantSolicitada<1){
                        ...
                        if(QuantSolicitada>QuantDisponivel){
                            ...
                            ObjSaida.Alterar_Quantidade_Na_Tabela(JTF_Quantidade.getText(),ObjSaida.numero_linha-1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Escolha_Nova_Quant_Saida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Escolha_Nova_Quant_Saida dialog = new Escolha_Nova_Quant_Saida((Tela_Saida_Produto) new javax.swing.JInternalFrame(), true);
