...
public class Inf_Entrada_Nao_Encontrada extends javax.swing.JDialog {
    
    public static Tela_Consulta_Entrada ObjConsEnt;
    
    public Inf_Entrada_Nao_Encontrada(Tela_Consulta_Entrada parent, boolean modal) {
        this.ObjConsEnt = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
        setSize(320,130);
        setLocationRelativeTo(ObjConsEnt);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Entrada não encontrada!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Entrada_Nao_Encontrada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Entrada_Nao_Encontrada dialog = new Inf_Entrada_Nao_Encontrada(ObjConsEnt, true);
