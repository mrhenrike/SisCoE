...
public class Inf_Preencher_Campos_Categ extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Categoria_DL ObjCategoria;
    
    public Inf_Preencher_Campos_Categ(Tela_Cadastro_Categoria_DL parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Categ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_Campos_Categ dialog = new Inf_Preencher_Campos_Categ(ObjCategoria, true);
