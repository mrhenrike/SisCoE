...
public class Inf_Preencher_Campos_Curso extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Curso_Turma ObjCurso;
    
    public Inf_Preencher_Campos_Curso(Tela_Cadastro_Curso_Turma parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Preencher_Campos_Curso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Preencher_Campos_Curso dialog = new Inf_Preencher_Campos_Curso(ObjCurso, true);
