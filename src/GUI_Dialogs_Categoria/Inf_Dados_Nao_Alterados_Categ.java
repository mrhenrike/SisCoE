...
public class Inf_Dados_Nao_Alterados_Categ extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Categoria_DL ObjCategoria;
    
    public Inf_Dados_Nao_Alterados_Categ(Tela_Cadastro_Categoria_DL parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Os dados não foram Alterados!");

        JB_Ok.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icones/Bt Ok.png"))); // NOI18N
        JB_Ok.setMnemonic('o');
        JB_Ok.setToolTipText("Ok (Alt+O)");
        JB_Ok.setMaximumSize(new java.awt.Dimension(140, 40));
        JB_Ok.setMinimumSize(new java.awt.Dimension(140, 40));
        JB_Ok.setPreferredSize(new java.awt.Dimension(140, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Nao_Alterados_Categ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Nao_Alterados_Categ dialog = new Inf_Dados_Nao_Alterados_Categ(ObjCategoria, true);
