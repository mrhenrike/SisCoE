...
public class Inf_Saida_Nao_Encontrada_Relat_Saida_Disciplina extends javax.swing.JDialog {
    
    public static Tela_Relat_Saida_Disciplina Obj;
    
    public Inf_Saida_Nao_Encontrada_Relat_Saida_Disciplina(Tela_Relat_Saida_Disciplina parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Saída não encontrada!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Saida_Nao_Encontrada_Relat_Saida_Disciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Saida_Nao_Encontrada_Relat_Saida_Disciplina dialog = new Inf_Saida_Nao_Encontrada_Relat_Saida_Disciplina(Obj, true);
