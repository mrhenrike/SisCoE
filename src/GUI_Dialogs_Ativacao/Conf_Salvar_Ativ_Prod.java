...
public class Conf_Salvar_Ativ_Prod extends javax.swing.JDialog {
    
    public static Tela_Ativacao ObjAtiv;
    
    
    public Conf_Salvar_Ativ_Prod(Tela_Ativacao parent, boolean modal) {
        this.ObjAtiv = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        setTitle("Confirmação Ao Ativar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Ativ_Prod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Ativ_Prod dialog = new Conf_Salvar_Ativ_Prod(ObjAtiv, true);
