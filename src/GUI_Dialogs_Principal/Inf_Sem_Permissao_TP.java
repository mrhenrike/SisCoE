...
public class Inf_Sem_Permissao_TP extends javax.swing.JDialog {
    
    public static Tela_Principal ObjTP;
    
    
    public Inf_Sem_Permissao_TP(Tela_Principal parent, boolean modal) {
        this.ObjTP = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("acessar essa rotina do sistema!");

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("Você não tem permissão para");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Sem_Permissao_TP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }      
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Inf_Sem_Permissao_TP dialog = new Inf_Sem_Permissao_TP(ObjTP, true);
