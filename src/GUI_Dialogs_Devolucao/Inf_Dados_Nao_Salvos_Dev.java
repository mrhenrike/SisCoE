...
public class Inf_Dados_Nao_Salvos_Dev extends javax.swing.JDialog {
    
    public static Tela_Gerar_Devolucao ObjDev;
    
    public Inf_Dados_Nao_Salvos_Dev(Tela_Gerar_Devolucao parent, boolean modal) {
        this.ObjDev = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("A devolução não foi efetivada!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Nao_Salvos_Dev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Nao_Salvos_Dev dialog = new Inf_Dados_Nao_Salvos_Dev(ObjDev, true);
