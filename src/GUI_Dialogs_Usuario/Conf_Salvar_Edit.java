...
public class Conf_Salvar_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Usuario_Edit ObjUserEdit;
    
    
    public Conf_Salvar_Edit(Tela_Cadastro_Usuario_Edit parent, boolean modal) {
    ...
    private void JB_SimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB_SimActionPerformed
       dispose();
       ObjUserEdit.Conf_Alterar_Usario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Salvar_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Salvar_Edit dialog = new Conf_Salvar_Edit(ObjUserEdit, true);
