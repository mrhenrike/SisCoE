...
public class Inf_Dados_Salvos_Curso_Edit extends javax.swing.JDialog {
    
    public static Tela_Cadastro_Curso_Edit ObjCurso;
    
    public Inf_Dados_Salvos_Curso_Edit(Tela_Cadastro_Curso_Edit parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Os dados foram Alterados!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Salvos_Curso_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Salvos_Curso_Edit dialog = new Inf_Dados_Salvos_Curso_Edit(ObjCurso, true);
