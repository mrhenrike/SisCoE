...
public class Inf_Dados_Salvos_AltSenha extends javax.swing.JDialog {
    
    public static Tela_Alterar_Senha ObjAletraSenha;
    
    public Inf_Dados_Salvos_AltSenha(Tela_Alterar_Senha parent, boolean modal) {
        this.ObjAletraSenha = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
        setSize(360,130);
        setLocationRelativeTo(ObjAletraSenha);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("As senhas foram alteradas!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inf_Dados_Salvos_AltSenha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inf_Dados_Salvos_AltSenha dialog = new Inf_Dados_Salvos_AltSenha(ObjAletraSenha, true);
