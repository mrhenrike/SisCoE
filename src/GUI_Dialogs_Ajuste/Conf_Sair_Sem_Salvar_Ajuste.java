...
public class Conf_Sair_Sem_Salvar_Ajuste extends javax.swing.JDialog {
    
   public static Tela_Ajuste_Estoque Obj;
    
    public Conf_Sair_Sem_Salvar_Ajuste(Tela_Ajuste_Estoque parent, boolean modal) {
        this.Obj = parent;
        this.setModal(modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conf_Sair_Sem_Salvar_Ajuste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
     
        /* Create and display the dialog */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Conf_Sair_Sem_Salvar_Ajuste dialog = new Conf_Sair_Sem_Salvar_Ajuste(Obj, true);
